...
#define LOW_PRECISION`),t}function Dg(s){let t="SHADOWMAP_TYPE_BASIC";return s.shadowMapType===Hh?t="SHADOWMAP_TYPE_PCF":s.shadowMapType===Gh?t="SHADOWMAP_TYPE_PCF_SOFT":s.shadowMapType===zn&&(t="SHADOWMAP_TYPE_VSM"),t}function Lg(s){let t="ENVMAP_TYPE_CUBE";if(s.envMap)switch(s.envMapMode){case fs:case ps:t="ENVMAP_TYPE_CUBE";break;case bo:t="ENVMAP_TYPE_CUBE_UV";break}return t}function Ig(s){let t="ENVMAP_MODE_REFLECTION";if(s.envMap)switch(s.envMapMode){case ps:t="ENVMAP_MODE_REFRACTION";break}return t}function Ug(s){let t="ENVMAP_BLENDING_NONE";if(s.envMap)switch(s.combine){case So:t="ENVMAP_BLENDING_MULTIPLY";break;case _d:t="ENVMAP_BLENDING_MIX";break;case vd:t="ENVMAP_BLENDING_ADD";break}return t}function Ng(s){const t=s.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),112)),texelHeight:n,maxMip:e}}function Fg(s,t,e,n){const i=s.getContext(),r=e.defines;let o=e.vertexShader,a=e.fragmentShader;const l=Dg(e),c=Lg(e),u=Ig(e),h=Ug(e),d=Ng(e),f=bg(e),g=wg(r),_=i.createProgram();let m,p,b=e.glslVersion?"#version "+e.glslVersion+`
...
void main() {
    ...
    `}}const Ce=class Ce{static register(t,e,n={}){return Ce._registry.set(t,e),Object.keys(n).length>0&&Ce._presets.set(t,n),Ce}static create(t,e={}){const n=Ce._registry.get(t);if(!n)throw new Error(`[ProceduralFactory] Unknown entity: '${t}'. Did you forget to register it?`);const r={...Ce._presets.get(t)||{},...e};return new n(r)}static build(t,e={}){return Ce.create(t,e).build()}static createBatch(t,e,n,i=42){let r=i;const o={next(){r|=0,r=r+1831565813|0;let l=Math.imul(r^r>>>15,1|r);return l=l+Math.imul(l^l>>>7,61|l)^l,((l^l>>>14)>>>0)/4294967296},range(l,c){return l+this.next()*(c-l)}},a=[];for(let l=0;l<e;l++){const c=n(l,o);a.push(Ce.create(t,{seed:i+l,...c}))}return a}static registerPreset(t,e,n){const i=`${t}::${e}`;return Ce._presets.set(i,n),Ce}static createFromPreset(t,e,n={}){const i=`${t}::${e}`,r=Ce._presets.get(i)||{};return Ce.create(t,{...r,...n})}static listRegistered(){return[...Ce._registry.keys()]}static has(t){return Ce._registry.has(t)}static clear(){Ce._registry.clear(),Ce._presets.clear()}};Bs(Ce,"_registry",new Map),Bs(Ce,"_presets",new Map);let As=Ce;const io={rose:{size:.75,dx:.4,dy:.8,petals:7,rings:14,startRx:2.42,zOff:.5,maxScale:2.2,maxR:.1,bowl:.35,taper:.75,curl:1.5,curlV:.15,twist:.4,twistV:0,c1:"#ffffff",c2:"#ff0000"},lotus:{size:1.2,dx:.55,dy:1,petals:6,rings:18,startRx:1.8,zOff:.3,maxScale:2.5,maxR:.15,bowl:1.2,taper:.75,curl:.8,curlV:.1,twist:.1,twistV:0,c1:"#fff0f5",c2:"#ff69b4"},chrysanthemum:{size:1.6,dx:.15,dy:.5,petals:12,rings:20,startRx:2.8,zOff:.15,maxScale:1.8,maxR:.05,bowl:.15,taper:.25,curl:2,curlV:.3,twist:.2,twistV:.1,c1:"#fffff0",c2:"#ffd700"},cherry:{size:.55,dx:.35,dy:.55,petals:5,rings:10,startRx:2,zOff:.4,maxScale:2,maxR:.08,bowl:.2,taper:.6,curl:.6,curlV:.1,twist:.1,twistV:0,c1:"#fff5f5",c2:"#ffb7c5"},tulip:{size:1,dx:.5,dy:.9,petals:6,rings:8,startRx:1.6,zOff:.2,maxScale:2.8,maxR:.02,bowl:.8,taper:1,curl:.4,curlV:.05,twist:0,twistV:0,c1:"#ff3333",c2:"#ff6600"},lily:{size:1.4,dx:.6,dy:1.2,petals:6,rings:12,startRx:2.2,zOff:.35,maxScale:2.4,maxR:.12,bowl:.6,taper:.55,curl:1.8,curlV:.2,twist:.3,twistV:.1,c1:"#ffffff",c2:"#ffcc00"}};function fl(s){const t=s.replace("#","");return[parseInt(t.substring(0,2),16)/255,parseInt(t.substring(2,4),16)/255,parseInt(t.substring(4,6),16)/255]}function Dh(s,t,e){const n=fl(s),i=fl(t);return[n[0]+(i[0]-n[0])*e,n[1]+(i[1]-n[1])*e,n[2]+(i[2]-n[2])*e]}function Qv(s,t,e){return e<.5?Dh(s,t,e*2):Dh(t,s,(e-.5)*2)}function tx(s){const t=fl(s);return new P(t[0],t[1],t[2])}function ex(s,t,e){const n=new kl;return n.moveTo(0,0),n.quadraticCurveTo(t,e,0,s),n.quadraticCurveTo(-t,e,0,0),new Ro(n,{curveSegments:24,steps:1,depth:.005,bevelEnabled:!0,bevelThickness:.005,bevelSize:.01,bevelSegments:10})}class Iu extends Is{constructor(t={}){const e=io[t.preset||"rose"]||io.rose;super({preset:"rose",rings:e.rings,petals:e.petals,color1:e.c1,color2:e.c2,size:e.size,dx:e.dx,dy:e.dy,maxRadius:e.maxR,maxScale:e.maxScale,startRx:e.startRx,zOffsetCoef:e.zOff,bowlDepth:e.bowl,taperPow:e.taper,baseCurl:e.curl,curlVar:e.curlV,baseTwist:e.twist,twistVar:e.twistV,metalness:0,roughness:.43,transmission:.17,sheen:.47,sheenColor:"#ff8899",sheenRoughness:.48,clearcoat:.1,veinStr:.6,veinWidth:3e3,veinColor:"#2d5a1e",midribStr:.7,lateralStr:.5,edgeLight:.2,hueShift:0,layerGap:.005,scaleDecay:.4,innerShrink:.9,...t}),this._shaderUniforms=null,this._curlAttr=null,this._twistAttr=null,this._randCurl=null,this._randTwist=null}_buildGeometry(){const t=this._params;return ex(t.size,t.dx,t.dy)}_buildMaterial(){const t=this._params;this._shaderUniforms={uBowlDepth:{value:t.bowlDepth},uVeinStr:{value:t.veinStr},uVeinWidth:{value:t.veinWidth},uVeinColor:{value:tx(t.veinColor)},uMidribStr:{value:t.midribStr},uLateralStr:{value:t.lateralStr},uSecStr:{value:.2},uMicroStr:{value:.06},uTaperPow:{value:t.taperPow},uEdgeLight:{value:t.edgeLight},uHueShift:{value:t.hueShift},uPetalSize:{value:t.size},uPetalDx:{value:t.dx}};const e=new Mn({metalness:t.metalness,roughness:t.roughness,transmission:t.transmission,thickness:.5,sheen:t.sheen,sheenColor:new ut(t.sheenColor),sheenRoughness:t.sheenRoughness,clearcoat:t.clearcoat,side:Pe}),n=this._shaderUniforms;return e.onBeforeCompile=i=>{Object.assign(i.uniforms,n),i.vertexShader=i.vertexShader.replace("#include <common>",`#include <common>
        ...
        }`,fragmentShader:rx}),this._bgMesh=new ne(new fn(2,2),this._bgMaterial),this._bgMesh.renderOrder=-1,this._bgMesh.frustumCulled=!1}}const ix=`
...
`;function Uh(s,t){if(t===Ad)return console.warn("THREE.BufferGeometryUtils.toTrianglesDrawMode(): Geometry already defined as triangles."),s;if(t===sl||t===nu){let e=s.getIndex();if(e===null){const o=[],a=s.getAttribute("position");if(a!==void 0){for(let l=0;l<a.count;l++)o.push(l);s.setIndex(o),e=s.getIndex()}else return console.error("THREE.BufferGeometryUtils.toTrianglesDrawMode(): Undefined position attribute. Processing not possible."),s}const n=e.count-2,i=[];if(t===sl)for(let o=1;o<=n;o++)i.push(e.getX(0)),i.push(e.getX(o)),i.push(e.getX(o+1));else for(let o=0;o<n;o++)o%2===0?(i.push(e.getX(o)),i.push(e.getX(o+1)),i.push(e.getX(o+2))):(i.push(e.getX(o+2)),i.push(e.getX(o+1)),i.push(e.getX(o)));i.length/3!==n&&console.error("THREE.BufferGeometryUtils.toTrianglesDrawMode(): Unable to generate correct amount of triangles.");const r=s.clone();return r.setIndex(i),r.clearGroups(),r}else return console.error("THREE.BufferGeometryUtils.toTrianglesDrawMode(): Unknown draw mode:",t),s}class Uu extends Ni{constructor(t){super(t),this.dracoLoader=null,this.ktx2Loader=null,this.meshoptDecoder=null,this.pluginCallbacks=[],this.register(function(e){return new hx(e)}),this.register(function(e){return new ux(e)}),this.register(function(e){return new yx(e)}),this.register(function(e){return new Mx(e)}),this.register(function(e){return new Sx(e)}),this.register(function(e){return new fx(e)}),this.register(function(e){return new px(e)}),this.register(function(e){return new mx(e)}),this.register(function(e){return new gx(e)}),this.register(function(e){return new cx(e)}),this.register(function(e){return new _x(e)}),this.register(function(e){return new dx(e)}),this.register(function(e){return new xx(e)}),this.register(function(e){return new vx(e)}),this.register(function(e){return new ax(e)}),this.register(function(e){return new bx(e)}),this.register(function(e){return new wx(e)})}load(t,e,n,i){const r=this;let o;if(this.resourcePath!=="")o=this.resourcePath;else if(this.path!==""){const c=er.extractUrlBase(t);o=er.resolveURL(c,this.path)}else o=er.extractUrlBase(t);this.manager.itemStart(t);const a=function(c){i?i(c):console.error(c),r.manager.itemError(t),r.manager.itemEnd(t)},l=new Hl(this.manager);l.setPath(this.path),l.setResponseType("arraybuffer"),l.setRequestHeader(this.requestHeader),l.setWithCredentials(this.withCredentials),l.load(t,function(c){try{r.parse(c,o,function(u){e(u),r.manager.itemEnd(t)},a)}catch(u){a(u)}},n,a)}setDRACOLoader(t){return this.dracoLoader=t,this}setKTX2Loader(t){return this.ktx2Loader=t,this}setMeshoptDecoder(t){return this.meshoptDecoder=t,this}register(t){return this.pluginCallbacks.indexOf(t)===-1&&this.pluginCallbacks.push(t),this}unregister(t){return this.pluginCallbacks.indexOf(t)!==-1&&this.pluginCallbacks.splice(this.pluginCallbacks.indexOf(t),1),this}parse(t,e,n,i){let r;const o={},a={},l=new TextDecoder;if(typeof t=="string")r=JSON.parse(t);else if(t instanceof ArrayBuffer)if(l.decode(new Uint8Array(t,0,4))===Nu){try{o[qt.KHR_BINARY_GLTF]=new Tx(t)}catch(h){i&&i(h);return}r=JSON.parse(o[qt.KHR_BINARY_GLTF].content)}else r=JSON.parse(l.decode(t));else r=t;if(r.asset===void 0||r.asset.version[0]<2){i&&i(new Error("THREE.GLTFLoader: Unsupported asset. glTF versions >=2.0 are supported."));return}const c=new Bx(r,{path:e||this.resourcePath||"",crossOrigin:this.crossOrigin,requestHeader:this.requestHeader,manager:this.manager,ktx2Loader:this.ktx2Loader,meshoptDecoder:this.meshoptDecoder});c.fileLoader.setRequestHeader(this.requestHeader);for(let u=0;u<this.pluginCallbacks.length;u++){const h=this.pluginCallbacks[u](c);h.name||console.error("THREE.GLTFLoader: Invalid plugin found: missing name"),a[h.name]=h,o[h.name]=!0}if(r.extensionsUsed)for(let u=0;u<r.extensionsUsed.length;++u){const h=r.extensionsUsed[u],d=r.extensionsRequired||[];switch(h){case qt.KHR_MATERIALS_UNLIT:o[h]=new lx;break;case qt.KHR_DRACO_MESH_COMPRESSION:o[h]=new Ex(r,this.dracoLoader);break;case qt.KHR_TEXTURE_TRANSFORM:o[h]=new Ax;break;case qt.KHR_MESH_QUANTIZATION:o[h]=new Rx;break;default:d.indexOf(h)>=0&&a[h]===void 0&&console.warn('THREE.GLTFLoader: Unknown extension "'+h+'".')}}c.setExtensions(o),c.setPlugins(a),c.parse(n,i)}parseAsync(t,e){const n=this;return new Promise(function(i,r){n.parse(t,e,i,r)})}}function ox(){let s={};return{get:function(t){return s[t]},add:function(t,e){s[t]=e},remove:function(t){delete s[t]},removeAll:function(){s={}}}}const qt={KHR_BINARY_GLTF:"KHR_binary_glTF",KHR_DRACO_MESH_COMPRESSION:"KHR_draco_mesh_compression",KHR_LIGHTS_PUNCTUAL:"KHR_lights_punctual",KHR_MATERIALS_CLEARCOAT:"KHR_materials_clearcoat",KHR_MATERIALS_DISPERSION:"KHR_materials_dispersion",KHR_MATERIALS_IOR:"KHR_materials_ior",KHR_MATERIALS_SHEEN:"KHR_materials_sheen",KHR_MATERIALS_SPECULAR:"KHR_materials_specular",KHR_MATERIALS_TRANSMISSION:"KHR_materials_transmission",KHR_MATERIALS_IRIDESCENCE:"KHR_materials_iridescence",KHR_MATERIALS_ANISOTROPY:"KHR_materials_anisotropy",KHR_MATERIALS_UNLIT:"KHR_materials_unlit",KHR_MATERIALS_VOLUME:"KHR_materials_volume",KHR_TEXTURE_BASISU:"KHR_texture_basisu",KHR_TEXTURE_TRANSFORM:"KHR_texture_transform",KHR_MESH_QUANTIZATION:"KHR_mesh_quantization",KHR_MATERIALS_EMISSIVE_STRENGTH:"KHR_materials_emissive_strength",EXT_MATERIALS_BUMP:"EXT_materials_bump",EXT_TEXTURE_WEBP:"EXT_texture_webp",EXT_TEXTURE_AVIF:"EXT_texture_avif",EXT_MESHOPT_COMPRESSION:"EXT_meshopt_compression",EXT_MESH_GPU_INSTANCING:"EXT_mesh_gpu_instancing"};class ax{constructor(t){this.parser=t,this.name=qt.KHR_LIGHTS_PUNCTUAL,this.cache={refs:{},uses:{}}}_markDefs(){const t=this.parser,e=this.parser.json.nodes||[];for(let n=0,i=e.length;n<i;n++){const r=e[n];r.extensions&&r.extensions[this.name]&&r.extensions[this.name].light!==void 0&&t._addNodeRef(this.cache,r.extensions[this.name].light)}}_loadLight(t){const e=this.parser,n="light:"+t;let i=e.cache.get(n);if(i)return i;const r=e.json,l=((r.extensions&&r.extensions[this.name]||{}).lights||[])[t];let c;const u=new ut(16777215);l.color!==void 0&&u.setRGB(l.color[0],l.color[1],l.color[2],Xe);const h=l.range!==void 0?l.range:0;switch(l.type){case"directional":c=new cs(u),c.target.position.set(0,0,-1),c.add(c.target);break;case"point":c=new Ls(u),c.distance=h;break;case"spot":c=new Ds(u),c.distance=h,l.spot=l.spot||{},l.spot.innerConeAngle=l.spot.innerConeAngle!==void 0?l.spot.innerConeAngle:0,l.spot.outerConeAngle=l.spot.outerConeAngle!==void 0?l.spot.outerConeAngle:Math.PI/4,c.angle=l.spot.outerConeAngle,c.penumbra=1-l.spot.innerConeAngle/l.spot.outerConeAngle,c.target.position.set(0,0,-1),c.add(c.target);break;default:throw new Error("THREE.GLTFLoader: Unexpected light type: "+l.type)}return c.position.set(0,0,0),c.decay=2,kn(c,l),l.intensity!==void 0&&(c.intensity=l.intensity),c.name=e.createUniqueName(l.name||"light_"+t),i=Promise.resolve(c),e.cache.add(n,i),i}getDependency(t,e){if(t==="light")return this._loadLight(e)}createNodeAttachment(t){const e=this,n=this.parser,r=n.json.nodes[t],a=(r.extensions&&r.extensions[this.name]||{}).light;return a===void 0?null:this._loadLight(a).then(function(l){return n._getNodeRef(e.cache,a,l)})}}class lx{constructor(){this.name=qt.KHR_MATERIALS_UNLIT}getMaterialType(){return qn}extendParams(t,e,n){const i=[];t.color=new ut(1,1,1),t.opacity=1;const r=e.pbrMetallicRoughness;if(r){if(Array.isArray(r.baseColorFactor)){const o=r.baseColorFactor;t.color.setRGB(o[0],o[1],o[2],Xe),t.opacity=o[3]}r.baseColorTexture!==void 0&&i.push(n.assignTexture(t,"map",r.baseColorTexture,Te))}return Promise.all(i)}}class cx{constructor(t){this.parser=t,this.name=qt.KHR_MATERIALS_EMISSIVE_STRENGTH}extendMaterialParams(t,e){const i=this.parser.json.materials[t];if(!i.extensions||!i.extensions[this.name])return Promise.resolve();const r=i.extensions[this.name].emissiveStrength;return r!==void 0&&(e.emissiveIntensity=r),Promise.resolve()}}class hx{constructor(t){this.parser=t,this.name=qt.KHR_MATERIALS_CLEARCOAT}getMaterialType(t){const n=this.parser.json.materials[t];return!n.extensions||!n.extensions[this.name]?null:Mn}extendMaterialParams(t,e){const n=this.parser,i=n.json.materials[t];if(!i.extensions||!i.extensions[this.name])return Promise.resolve();const r=[],o=i.extensions[this.name];if(o.clearcoatFactor!==void 0&&(e.clearcoat=o.clearcoatFactor),o.clearcoatTexture!==void 0&&r.push(n.assignTexture(e,"clearcoatMap",o.clearcoatTexture)),o.clearcoatRoughnessFactor!==void 0&&(e.clearcoatRoughness=o.clearcoatRoughnessFactor),o.clearcoatRoughnessTexture!==void 0&&r.push(n.assignTexture(e,"clearcoatRoughnessMap",o.clearcoatRoughnessTexture)),o.clearcoatNormalTexture!==void 0&&(r.push(n.assignTexture(e,"clearcoatNormalMap",o.clearcoatNormalTexture)),o.clearcoatNormalTexture.scale!==void 0)){const a=o.clearcoatNormalTexture.scale;e.clearcoatNormalScale=new Z(a,a)}return Promise.all(r)}}class ux{constructor(t){this.parser=t,this.name=qt.KHR_MATERIALS_DISPERSION}getMaterialType(t){const n=this.parser.json.materials[t];return!n.extensions||!n.extensions[this.name]?null:Mn}extendMaterialParams(t,e){const i=this.parser.json.materials[t];if(!i.extensions||!i.extensions[this.name])return Promise.resolve();const r=i.extensions[this.name];return e.dispersion=r.dispersion!==void 0?r.dispersion:0,Promise.resolve()}}class dx{constructor(t){this.parser=t,this.name=qt.KHR_MATERIALS_IRIDESCENCE}getMaterialType(t){const n=this.parser.json.materials[t];return!n.extensions||!n.extensions[this.name]?null:Mn}extendMaterialParams(t,e){const n=this.parser,i=n.json.materials[t];if(!i.extensions||!i.extensions[this.name])return Promise.resolve();const r=[],o=i.extensions[this.name];return o.iridescenceFactor!==void 0&&(e.iridescence=o.iridescenceFactor),o.iridescenceTexture!==void 0&&r.push(n.assignTexture(e,"iridescenceMap",o.iridescenceTexture)),o.iridescenceIor!==void 0&&(e.iridescenceIOR=o.iridescenceIor),e.iridescenceThicknessRange===void 0&&(e.iridescenceThicknessRange=[100,400]),o.iridescenceThicknessMinimum!==void 0&&(e.iridescenceThicknessRange[0]=o.iridescenceThicknessMinimum),o.iridescenceThicknessMaximum!==void 0&&(e.iridescenceThicknessRange[1]=o.iridescenceThicknessMaximum),o.iridescenceThicknessTexture!==void 0&&r.push(n.assignTexture(e,"iridescenceThicknessMap",o.iridescenceThicknessTexture)),Promise.all(r)}}class fx{constructor(t){this.parser=t,this.name=qt.KHR_MATERIALS_SHEEN}getMaterialType(t){const n=this.parser.json.materials[t];return!n.extensions||!n.extensions[this.name]?null:Mn}extendMaterialParams(t,e){const n=this.parser,i=n.json.materials[t];if(!i.extensions||!i.extensions[this.name])return Promise.resolve();const r=[];e.sheenColor=new ut(0,0,0),e.sheenRoughness=0,e.sheen=1;const o=i.extensions[this.name];if(o.sheenColorFactor!==void 0){const a=o.sheenColorFactor;e.sheenColor.setRGB(a[0],a[1],a[2],Xe)}return o.sheenRoughnessFactor!==void 0&&(e.sheenRoughness=o.sheenRoughnessFactor),o.sheenColorTexture!==void 0&&r.push(n.assignTexture(e,"sheenColorMap",o.sheenColorTexture,Te)),o.sheenRoughnessTexture!==void 0&&r.push(n.assignTexture(e,"sheenRoughnessMap",o.sheenRoughnessTexture)),Promise.all(r)}}class px{constructor(t){this.parser=t,this.name=qt.KHR_MATERIALS_TRANSMISSION}getMaterialType(t){const n=this.parser.json.materials[t];return!n.extensions||!n.extensions[this.name]?null:Mn}extendMaterialParams(t,e){const n=this.parser,i=n.json.materials[t];if(!i.extensions||!i.extensions[this.name])return Promise.resolve();const r=[],o=i.extensions[this.name];return o.transmissionFactor!==void 0&&(e.transmission=o.transmissionFactor),o.transmissionTexture!==void 0&&r.push(n.assignTexture(e,"transmissionMap",o.transmissionTexture)),Promise.all(r)}}class mx{constructor(t){this.parser=t,this.name=qt.KHR_MATERIALS_VOLUME}getMaterialType(t){const n=this.parser.json.materials[t];return!n.extensions||!n.extensions[this.name]?null:Mn}extendMaterialParams(t,e){const n=this.parser,i=n.json.materials[t];if(!i.extensions||!i.extensions[this.name])return Promise.resolve();const r=[],o=i.extensions[this.name];e.thickness=o.thicknessFactor!==void 0?o.thicknessFactor:0,o.thicknessTexture!==void 0&&r.push(n.assignTexture(e,"thicknessMap",o.thicknessTexture)),e.attenuationDistance=o.attenuationDistance||1/0;const a=o.attenuationColor||[1,1,1];return e.attenuationColor=new ut().setRGB(a[0],a[1],a[2],Xe),Promise.all(r)}}class gx{constructor(t){this.parser=t,this.name=qt.KHR_MATERIALS_IOR}getMaterialType(t){const n=this.parser.json.materials[t];return!n.extensions||!n.extensions[this.name]?null:Mn}extendMaterialParams(t,e){const i=this.parser.json.materials[t];if(!i.extensions||!i.extensions[this.name])return Promise.resolve();const r=i.extensions[this.name];return e.ior=r.ior!==void 0?r.ior:1.5,Promise.resolve()}}class _x{constructor(t){this.parser=t,this.name=qt.KHR_MATERIALS_SPECULAR}getMaterialType(t){const n=this.parser.json.materials[t];return!n.extensions||!n.extensions[this.name]?null:Mn}extendMaterialParams(t,e){const n=this.parser,i=n.json.materials[t];if(!i.extensions||!i.extensions[this.name])return Promise.resolve();const r=[],o=i.extensions[this.name];e.specularIntensity=o.specularFactor!==void 0?o.specularFactor:1,o.specularTexture!==void 0&&r.push(n.assignTexture(e,"specularIntensityMap",o.specularTexture));const a=o.specularColorFactor||[1,1,1];return e.specularColor=new ut().setRGB(a[0],a[1],a[2],Xe),o.specularColorTexture!==void 0&&r.push(n.assignTexture(e,"specularColorMap",o.specularColorTexture,Te)),Promise.all(r)}}class vx{constructor(t){this.parser=t,this.name=qt.EXT_MATERIALS_BUMP}getMaterialType(t){const n=this.parser.json.materials[t];return!n.extensions||!n.extensions[this.name]?null:Mn}extendMaterialParams(t,e){const n=this.parser,i=n.json.materials[t];if(!i.extensions||!i.extensions[this.name])return Promise.resolve();const r=[],o=i.extensions[this.name];return e.bumpScale=o.bumpFactor!==void 0?o.bumpFactor:1,o.bumpTexture!==void 0&&r.push(n.assignTexture(e,"bumpMap",o.bumpTexture)),Promise.all(r)}}class xx{constructor(t){this.parser=t,this.name=qt.KHR_MATERIALS_ANISOTROPY}getMaterialType(t){const n=this.parser.json.materials[t];return!n.extensions||!n.extensions[this.name]?null:Mn}extendMaterialParams(t,e){const n=this.parser,i=n.json.materials[t];if(!i.extensions||!i.extensions[this.name])return Promise.resolve();const r=[],o=i.extensions[this.name];return o.anisotropyStrength!==void 0&&(e.anisotropy=o.anisotropyStrength),o.anisotropyRotation!==void 0&&(e.anisotropyRotation=o.anisotropyRotation),o.anisotropyTexture!==void 0&&r.push(n.assignTexture(e,"anisotropyMap",o.anisotropyTexture)),Promise.all(r)}}class yx{constructor(t){this.parser=t,this.name=qt.KHR_TEXTURE_BASISU}loadTexture(t){const e=this.parser,n=e.json,i=n.textures[t];if(!i.extensions||!i.extensions[this.name])return null;const r=i.extensions[this.name],o=e.options.ktx2Loader;if(!o){if(n.extensionsRequired&&n.extensionsRequired.indexOf(this.name)>=0)throw new Error("THREE.GLTFLoader: setKTX2Loader must be called before loading KTX2 textures");return null}return e.loadTextureImage(t,r.source,o)}}class Mx{constructor(t){this.parser=t,this.name=qt.EXT_TEXTURE_WEBP,this.isSupported=null}loadTexture(t){const e=this.name,n=this.parser,i=n.json,r=i.textures[t];if(!r.extensions||!r.extensions[e])return null;const o=r.extensions[e],a=i.images[o.source];let l=n.textureLoader;if(a.uri){const c=n.options.manager.getHandler(a.uri);c!==null&&(l=c)}return this.detectSupport().then(function(c){if(c)return n.loadTextureImage(t,o.source,l);if(i.extensionsRequired&&i.extensionsRequired.indexOf(e)>=0)throw new Error("THREE.GLTFLoader: WebP required by asset but unsupported.");return n.loadTexture(t)})}detectSupport(){return this.isSupported||(this.isSupported=new Promise(function(t){const e=new Image;e.src="data:image/webp;base64,UklGRiIAAABXRUJQVlA4IBYAAAAwAQCdASoBAAEADsD+JaQAA3AAAAAA",e.onload=e.onerror=function(){t(e.height===1)}})),this.isSupported}}class Sx{constructor(t){this.parser=t,this.name=qt.EXT_TEXTURE_AVIF,this.isSupported=null}loadTexture(t){const e=this.name,n=this.parser,i=n.json,r=i.textures[t];if(!r.extensions||!r.extensions[e])return null;const o=r.extensions[e],a=i.images[o.source];let l=n.textureLoader;if(a.uri){const c=n.options.manager.getHandler(a.uri);c!==null&&(l=c)}return this.detectSupport().then(function(c){if(c)return n.loadTextureImage(t,o.source,l);if(i.extensionsRequired&&i.extensionsRequired.indexOf(e)>=0)throw new Error("THREE.GLTFLoader: AVIF required by asset but unsupported.");return n.loadTexture(t)})}detectSupport(){return this.isSupported||(this.isSupported=new Promise(function(t){const e=new Image;e.src="data:image/avif;base64,",e.onload=e.onerror=function(){t(e.height===1)}})),this.isSupported}}class bx{constructor(t){this.name=qt.EXT_MESHOPT_COMPRESSION,this.parser=t}loadBufferView(t){const e=this.parser.json,n=e.bufferViews[t];if(n.extensions&&n.extensions[this.name]){const i=n.extensions[this.name],r=this.parser.getDependency("buffer",i.buffer),o=this.parser.options.meshoptDecoder;if(!o||!o.supported){if(e.extensionsRequired&&e.extensionsRequired.indexOf(this.name)>=0)throw new Error("THREE.GLTFLoader: setMeshoptDecoder must be called before loading compressed files");return null}return r.then(function(a){const l=i.byteOffset||0,c=i.byteLength||0,u=i.count,h=i.byteStride,d=new Uint8Array(a,l,c);return o.decodeGltfBufferAsync?o.decodeGltfBufferAsync(u,h,d,i.mode,i.filter).then(function(f){return f.buffer}):o.ready.then(function(){const f=new ArrayBuffer(u*h);return o.decodeGltfBuffer(new Uint8Array(f),u,h,d,i.mode,i.filter),f})})}else return null}}class wx{constructor(t){this.name=qt.EXT_MESH_GPU_INSTANCING,this.parser=t}createNodeMesh(t){const e=this.parser.json,n=e.nodes[t];if(!n.extensions||!n.extensions[this.name]||n.mesh===void 0)return null;const i=e.meshes[n.mesh];for(const c of i.primitives)if(c.mode!==an.TRIANGLES&&c.mode!==an.TRIANGLE_STRIP&&c.mode!==an.TRIANGLE_FAN&&c.mode!==void 0)return null;const o=n.extensions[this.name].attributes,a=[],l={};for(const c in o)a.push(this.parser.getDependency("accessor",o[c]).then(u=>(l[c]=u,l[c])));return a.length<1?null:(a.push(this.parser.createNodeMesh(t)),Promise.all(a).then(c=>{const u=c.pop(),h=u.isGroup?u.children:[u],d=c[0].count,f=[];for(const g of h){const _=new zt,m=new P,p=new An,b=new P(1,1,1),x=new gr(g.geometry,g.material,d);for(let v=0;v<d;v++)l.TRANSLATION&&m.fromBufferAttribute(l.TRANSLATION,v),l.ROTATION&&p.fromBufferAttribute(l.ROTATION,v),l.SCALE&&b.fromBufferAttribute(l.SCALE,v),x.setMatrixAt(v,_.compose(m,p,b));for(const v in l)if(v==="_COLOR_0"){const C=l[v];x.instanceColor=new Di(C.array,C.itemSize,C.normalized)}else v!=="TRANSLATION"&&v!=="ROTATION"&&v!=="SCALE"&&g.geometry.setAttribute(v,l[v]);ie.prototype.copy.call(x,g),this.parser.assignFinalMaterial(x),f.push(x)}return u.isGroup?(u.clear(),u.add(...f),u):f[0]}))}}const Nu="glTF",Ys=12,Nh={JSON:1313821514,BIN:5130562};class Tx{constructor(t){this.name=qt.KHR_BINARY_GLTF,this.content=null,this.body=null;const e=new DataView(t,0,Ys),n=new TextDecoder;if(this.header={magic:n.decode(new Uint8Array(t.slice(0,4))),version:e.getUint32(4,!0),length:e.getUint32(8,!0)},this.header.magic!==Nu)throw new Error("THREE.GLTFLoader: Unsupported glTF-Binary header.");if(this.header.version<2)throw new Error("THREE.GLTFLoader: Legacy binary file detected.");const i=this.header.length-Ys,r=new DataView(t,Ys);let o=0;for(;o<i;){const a=r.getUint32(o,!0);o+=4;const l=r.getUint32(o,!0);if(o+=4,l===Nh.JSON){const c=new Uint8Array(t,Ys+o,a);this.content=n.decode(c)}else if(l===Nh.BIN){const c=Ys+o;this.body=t.slice(c,c+a)}o+=a}if(this.content===null)throw new Error("THREE.GLTFLoader: JSON content not found.")}}class Ex{constructor(t,e){if(!e)throw new Error("THREE.GLTFLoader: No DRACOLoader instance provided.");this.name=qt.KHR_DRACO_MESH_COMPRESSION,this.json=t,this.dracoLoader=e,this.dracoLoader.preload()}decodePrimitive(t,e){const n=this.json,i=this.dracoLoader,r=t.extensions[this.name].bufferView,o=t.extensions[this.name].attributes,a={},l={},c={};for(const u in o){const h=pl[u]||u.toLowerCase();a[h]=o[u]}for(const u in t.attributes){const h=pl[u]||u.toLowerCase();if(o[u]!==void 0){const d=n.accessors[t.attributes[u]],f=hs[d.componentType];c[h]=f.name,l[h]=d.normalized===!0}}return e.getDependency("bufferView",r).then(function(u){return new Promise(function(h,d){i.decodeDracoFile(u,function(f){for(const g in f.attributes){const _=f.attributes[g],m=l[g];m!==void 0&&(_.normalized=m)}h(f)},a,c,Xe,d)})})}}class Ax{constructor(){this.name=qt.KHR_TEXTURE_TRANSFORM}extendTexture(t,e){return(e.texCoord===void 0||e.texCoord===t.channel)&&e.offset===void 0&&e.rotation===void 0&&e.scale===void 0||(t=t.clone(),e.texCoord!==void 0&&(t.channel=e.texCoord),e.offset!==void 0&&t.offset.fromArray(e.offset),e.rotation!==void 0&&(t.rotation=e.rotation),e.scale!==void 0&&t.repeat.fromArray(e.scale),t.needsUpdate=!0),t}}class Rx{constructor(){this.name=qt.KHR_MESH_QUANTIZATION}}class Fu extends _r{constructor(t,e,n,i){super(t,e,n,i)}copySampleValue_(t){const e=this.resultBuffer,n=this.sampleValues,i=this.valueSize,r=t*i*3+i;for(let o=0;o!==i;o++)e[o]=n[r+o];return e}interpolate_(t,e,n,i){const r=this.resultBuffer,o=this.sampleValues,a=this.valueSize,l=a*2,c=a*3,u=i-e,h=(n-e)/u,d=h*h,f=d*h,g=t*c,_=g-c,m=-2*f+3*d,p=f-d,b=1-m,x=p-d+h;for(let v=0;v!==a;v++){const C=o[_+v+a],T=o[_+v+l]*u,E=o[g+v+a],A=o[g+v]*u;r[v]=b*C+x*T+m*E+p*A}return r}}const Cx=new An;class Px extends Fu{interpolate_(t,e,n,i){const r=super.interpolate_(t,e,n,i);return Cx.fromArray(r).normalize().toArray(r),r}}const an={POINTS:0,LINES:1,LINE_LOOP:2,LINE_STRIP:3,TRIANGLES:4,TRIANGLE_STRIP:5,TRIANGLE_FAN:6},hs={5120:Int8Array,5121:Uint8Array,5122:Int16Array,5123:Uint16Array,5125:Uint32Array,5126:Float32Array},Fh={9728:De,9729:Me,9984:qh,9985:ro,9986:js,9987:Tn},Oh={33071:hn,33648:mo,10497:wn},pa={SCALAR:1,VEC2:2,VEC3:3,VEC4:4,MAT2:4,MAT3:9,MAT4:16},pl={POSITION:"position",NORMAL:"normal",TANGENT:"tangent",TEXCOORD_0:"uv",TEXCOORD_1:"uv1",TEXCOORD_2:"uv2",TEXCOORD_3:"uv3",COLOR_0:"color",WEIGHTS_0:"skinWeight",JOINTS_0:"skinIndex"},ci={scale:"scale",translation:"position",rotation:"quaternion",weights:"morphTargetInfluences"},Dx={CUBICSPLINE:void 0,LINEAR:rr,STEP:sr},ma={OPAQUE:"OPAQUE",MASK:"MASK",BLEND:"BLEND"};function Lx(s){return s.DefaultMaterial===void 0&&(s.DefaultMaterial=new Ss({color:16777215,emissive:0,metalness:1,roughness:1,transparent:!1,depthTest:!0,side:yn})),s.DefaultMaterial}function bi(s,t,e){for(const n in e.extensions)s[n]===void 0&&(t.userData.gltfExtensions=t.userData.gltfExtensions||{},t.userData.gltfExtensions[n]=e.extensions[n])}function kn(s,t){t.extras!==void 0&&(typeof t.extras=="object"?Object.assign(s.userData,t.extras):console.warn("THREE.GLTFLoader: Ignoring primitive type .extras, "+t.extras))}function Ix(s,t,e){let n=!1,i=!1,r=!1;for(let c=0,u=t.length;c<u;c++){const h=t[c];if(h.POSITION!==void 0&&(n=!0),h.NORMAL!==void 0&&(i=!0),h.COLOR_0!==void 0&&(r=!0),n&&i&&r)break}if(!n&&!i&&!r)return Promise.resolve(s);const o=[],a=[],l=[];for(let c=0,u=t.length;c<u;c++){const h=t[c];if(n){const d=h.POSITION!==void 0?e.getDependency("accessor",h.POSITION):s.attributes.position;o.push(d)}if(i){const d=h.NORMAL!==void 0?e.getDependency("accessor",h.NORMAL):s.attributes.normal;a.push(d)}if(r){const d=h.COLOR_0!==void 0?e.getDependency("accessor",h.COLOR_0):s.attributes.color;l.push(d)}}return Promise.all([Promise.all(o),Promise.all(a),Promise.all(l)]).then(function(c){const u=c[0],h=c[1],d=c[2];return n&&(s.morphAttributes.position=u),i&&(s.morphAttributes.normal=h),r&&(s.morphAttributes.color=d),s.morphTargetsRelative=!0,s})}function Ux(s,t){if(s.updateMorphTargets(),t.weights!==void 0)for(let e=0,n=t.weights.length;e<n;e++)s.morphTargetInfluences[e]=t.weights[e];if(t.extras&&Array.isArray(t.extras.targetNames)){const e=t.extras.targetNames;if(s.morphTargetInfluences.length===e.length){s.morphTargetDictionary={};for(let n=0,i=e.length;n<i;n++)s.morphTargetDictionary[e[n]]=n}else console.warn("THREE.GLTFLoader: Invalid extras.targetNames length. Ignoring names.")}}function Nx(s){let t;const e=s.extensions&&s.extensions[qt.KHR_DRACO_MESH_COMPRESSION];if(e?t="draco:"+e.bufferView+":"+e.indices+":"+ga(e.attributes):t=s.indices+":"+ga(s.attributes)+":"+s.mode,s.targets!==void 0)for(let n=0,i=s.targets.length;n<i;n++)t+=":"+ga(s.targets[n]);return t}function ga(s){let t="";const e=Object.keys(s).sort();for(let n=0,i=e.length;n<i;n++)t+=e[n]+":"+s[e[n]]+";";return t}function ml(s){switch(s){case Int8Array:return 1/127;case Uint8Array:return 1/255;case Int16Array:return 1/32767;case Uint16Array:return 1/65535;default:throw new Error("THREE.GLTFLoader: Unsupported normalized accessor component type.")}}function Fx(s){return s.search(/\.jpe?g($|\?)/i)>0||s.search(/^data\:image\/jpeg/)===0?"image/jpeg":s.search(/\.webp($|\?)/i)>0||s.search(/^data\:image\/webp/)===0?"image/webp":s.search(/\.ktx2($|\?)/i)>0||s.search(/^data\:image\/ktx2/)===0?"image/ktx2":"image/png"}const Ox=new zt;class Bx{constructor(t={},e={}){this.json=t,this.extensions={},this.plugins={},this.options=e,this.cache=new ox,this.associations=new Map,this.primitiveCache={},this.nodeCache={},this.meshCache={refs:{},uses:{}},this.cameraCache={refs:{},uses:{}},this.lightCache={refs:{},uses:{}},this.sourceCache={},this.textureCache={},this.nodeNamesUsed={};let n=!1,i=-1,r=!1,o=-1;if(typeof navigator<"u"){const a=navigator.userAgent;n=/^((?!chrome|android).)*safari/i.test(a)===!0;const l=a.match(/Version\/(\d+)/);i=n&&l?parseInt(l[1],10):-1,r=a.indexOf("Firefox")>-1,o=r?a.match(/Firefox\/([0-9]+)\./)[1]:-1}typeof createImageBitmap>"u"||n&&i<17||r&&o<98?this.textureLoader=new Cu(this.options.manager):this.textureLoader=new yv(this.options.manager),this.textureLoader.setCrossOrigin(this.options.crossOrigin),this.textureLoader.setRequestHeader(this.options.requestHeader),this.fileLoader=new Hl(this.options.manager),this.fileLoader.setResponseType("arraybuffer"),this.options.crossOrigin==="use-credentials"&&this.fileLoader.setWithCredentials(!0)}setExtensions(t){this.extensions=t}setPlugins(t){this.plugins=t}parse(t,e){const n=this,i=this.json,r=this.extensions;this.cache.removeAll(),this.nodeCache={},this._invokeAll(function(o){return o._markDefs&&o._markDefs()}),Promise.all(this._invokeAll(function(o){return o.beforeRoot&&o.beforeRoot()})).then(function(){return Promise.all([n.getDependencies("scene"),n.getDependencies("animation"),n.getDependencies("camera")])}).then(function(o){const a={scene:o[0][i.scene||0],scenes:o[0],animations:o[1],cameras:o[2],asset:i.asset,parser:n,userData:{}};return bi(r,a,i),kn(a,i),Promise.all(n._invokeAll(function(l){return l.afterRoot&&l.afterRoot(a)})).then(function(){for(const l of a.scenes)l.updateMatrixWorld();t(a)})}).catch(e)}_markDefs(){const t=this.json.nodes||[],e=this.json.skins||[],n=this.json.meshes||[];for(let i=0,r=e.length;i<r;i++){const o=e[i].joints;for(let a=0,l=o.length;a<l;a++)t[o[a]].isBone=!0}for(let i=0,r=t.length;i<r;i++){const o=t[i];o.mesh!==void 0&&(this._addNodeRef(this.meshCache,o.mesh),o.skin!==void 0&&(n[o.mesh].isSkinnedMesh=!0)),o.camera!==void 0&&this._addNodeRef(this.cameraCache,o.camera)}}_addNodeRef(t,e){e!==void 0&&(t.refs[e]===void 0&&(t.refs[e]=t.uses[e]=0),t.refs[e]++)}_getNodeRef(t,e,n){if(t.refs[e]<=1)return n;const i=n.clone(),r=(o,a)=>{const l=this.associations.get(o);l!=null&&this.associations.set(a,l);for(const[c,u]of o.children.entries())r(u,a.children[c])};return r(n,i),i.name+="_instance_"+t.uses[e]++,i}_invokeOne(t){const e=Object.values(this.plugins);e.push(this);for(let n=0;n<e.length;n++){const i=t(e[n]);if(i)return i}return null}_invokeAll(t){const e=Object.values(this.plugins);e.unshift(this);const n=[];for(let i=0;i<e.length;i++){const r=t(e[i]);r&&n.push(r)}return n}getDependency(t,e){const n=t+":"+e;let i=this.cache.get(n);if(!i){switch(t){case"scene":i=this.loadScene(e);break;case"node":i=this._invokeOne(function(r){return r.loadNode&&r.loadNode(e)});break;case"mesh":i=this._invokeOne(function(r){return r.loadMesh&&r.loadMesh(e)});break;case"accessor":i=this.loadAccessor(e);break;case"bufferView":i=this._invokeOne(function(r){return r.loadBufferView&&r.loadBufferView(e)});break;case"buffer":i=this.loadBuffer(e);break;case"material":i=this._invokeOne(function(r){return r.loadMaterial&&r.loadMaterial(e)});break;case"texture":i=this._invokeOne(function(r){return r.loadTexture&&r.loadTexture(e)});break;case"skin":i=this.loadSkin(e);break;case"animation":i=this._invokeOne(function(r){return r.loadAnimation&&r.loadAnimation(e)});break;case"camera":i=this.loadCamera(e);break;default:if(i=this._invokeOne(function(r){return r!=this&&r.getDependency&&r.getDependency(t,e)}),!i)throw new Error("Unknown type: "+t);break}this.cache.add(n,i)}return i}getDependencies(t){let e=this.cache.get(t);if(!e){const n=this,i=this.json[t+(t==="mesh"?"es":"s")]||[];e=Promise.all(i.map(function(r,o){return n.getDependency(t,o)})),this.cache.add(t,e)}return e}loadBuffer(t){const e=this.json.buffers[t],n=this.fileLoader;if(e.type&&e.type!=="arraybuffer")throw new Error("THREE.GLTFLoader: "+e.type+" buffer type is not supported.");if(e.uri===void 0&&t===0)return Promise.resolve(this.extensions[qt.KHR_BINARY_GLTF].body);const i=this.options;return new Promise(function(r,o){n.load(er.resolveURL(e.uri,i.path),r,void 0,function(){o(new Error('THREE.GLTFLoader: Failed to load buffer "'+e.uri+'".'))})})}loadBufferView(t){const e=this.json.bufferViews[t];return this.getDependency("buffer",e.buffer).then(function(n){const i=e.byteLength||0,r=e.byteOffset||0;return n.slice(r,r+i)})}loadAccessor(t){const e=this,n=this.json,i=this.json.accessors[t];if(i.bufferView===void 0&&i.sparse===void 0){const o=pa[i.type],a=hs[i.componentType],l=i.normalized===!0,c=new a(i.count*o);return Promise.resolve(new pe(c,o,l))}const r=[];return i.bufferView!==void 0?r.push(this.getDependency("bufferView",i.bufferView)):r.push(null),i.sparse!==void 0&&(r.push(this.getDependency("bufferView",i.sparse.indices.bufferView)),r.push(this.getDependency("bufferView",i.sparse.values.bufferView))),Promise.all(r).then(function(o){const a=o[0],l=pa[i.type],c=hs[i.componentType],u=c.BYTES_PER_ELEMENT,h=u*l,d=i.byteOffset||0,f=i.bufferView!==void 0?n.bufferViews[i.bufferView].byteStride:void 0,g=i.normalized===!0;let _,m;if(f&&f!==h){const p=Math.floor(d/f),b="InterleavedBuffer:"+i.bufferView+":"+i.componentType+":"+p+":"+i.count;let x=e.cache.get(b);x||(_=new c(a,p*f,i.count*f/u),x=new g_(_,f/u),e.cache.add(b,x)),m=new Ll(x,l,d%f/u,g)}else a===null?_=new c(i.count*l):_=new c(a,d,i.count*l),m=new pe(_,l,g);if(i.sparse!==void 0){const p=pa.SCALAR,b=hs[i.sparse.indices.componentType],x=i.sparse.indices.byteOffset||0,v=i.sparse.values.byteOffset||0,C=new b(o[1],x,i.sparse.count*p),T=new c(o[2],v,i.sparse.count*l);a!==null&&(m=new pe(m.array.slice(),m.itemSize,m.normalized)),m.normalized=!1;for(let E=0,A=C.length;E<A;E++){const M=C[E];if(m.setX(M,T[E*l]),l>=2&&m.setY(M,T[E*l+1]),l>=3&&m.setZ(M,T[E*l+2]),l>=4&&m.setW(M,T[E*l+3]),l>=5)throw new Error("THREE.GLTFLoader: Unsupported itemSize in sparse BufferAttribute.")}m.normalized=g}return m})}loadTexture(t){const e=this.json,n=this.options,r=e.textures[t].source,o=e.images[r];let a=this.textureLoader;if(o.uri){const l=n.manager.getHandler(o.uri);l!==null&&(a=l)}return this.loadTextureImage(t,r,a)}loadTextureImage(t,e,n){const i=this,r=this.json,o=r.textures[t],a=r.images[e],l=(a.uri||a.bufferView)+":"+o.sampler;if(this.textureCache[l])return this.textureCache[l];const c=this.loadImageSource(e,n).then(function(u){u.flipY=!1,u.name=o.name||a.name||"",u.name===""&&typeof a.uri=="string"&&a.uri.startsWith("data:image/")===!1&&(u.name=a.uri);const d=(r.samplers||{})[o.sampler]||{};return u.magFilter=Fh[d.magFilter]||Me,u.minFilter=Fh[d.minFilter]||Tn,u.wrapS=Oh[d.wrapS]||wn,u.wrapT=Oh[d.wrapT]||wn,u.generateMipmaps=!u.isCompressedTexture&&u.minFilter!==De&&u.minFilter!==Me,i.associations.set(u,{textures:t}),u}).catch(function(){return null});return this.textureCache[l]=c,c}loadImageSource(t,e){const n=this,i=this.json,r=this.options;if(this.sourceCache[t]!==void 0)return this.sourceCache[t].then(h=>h.clone());const o=i.images[t],a=self.URL||self.webkitURL;let l=o.uri||"",c=!1;if(o.bufferView!==void 0)l=n.getDependency("bufferView",o.bufferView).then(function(h){c=!0;const d=new Blob([h],{type:o.mimeType});return l=a.createObjectURL(d),l});else if(o.uri===void 0)throw new Error("THREE.GLTFLoader: Image "+t+" is missing URI and bufferView");const u=Promise.resolve(l).then(function(h){return new Promise(function(d,f){let g=d;e.isImageBitmapLoader===!0&&(g=function(_){const m=new Be(_);m.needsUpdate=!0,d(m)}),e.load(er.resolveURL(h,r.path),g,void 0,f)})}).then(function(h){return c===!0&&a.revokeObjectURL(l),kn(h,o),h.userData.mimeType=o.mimeType||Fx(o.uri),h}).catch(function(h){throw console.error("THREE.GLTFLoader: Couldn't load texture",l),h});return this.sourceCache[t]=u,u}assignTexture(t,e,n,i){const r=this;return this.getDependency("texture",n.index).then(function(o){if(!o)return null;if(n.texCoord!==void 0&&n.texCoord>0&&(o=o.clone(),o.channel=n.texCoord),r.extensions[qt.KHR_TEXTURE_TRANSFORM]){const a=n.extensions!==void 0?n.extensions[qt.KHR_TEXTURE_TRANSFORM]:void 0;if(a){const l=r.associations.get(o);o=r.extensions[qt.KHR_TEXTURE_TRANSFORM].extendTexture(o,a),r.associations.set(o,l)}}return i!==void 0&&(o.colorSpace=i),t[e]=o,o})}assignFinalMaterial(t){const e=t.geometry;let n=t.material;const i=e.attributes.tangent===void 0,r=e.attributes.color!==void 0,o=e.attributes.normal===void 0;if(t.isPoints){const a="PointsMaterial:"+n.uuid;let l=this.cache.get(a);l||(l=new Nl,dn.prototype.copy.call(l,n),l.color.copy(n.color),l.map=n.map,l.sizeAttenuation=!1,this.cache.add(a,l)),n=l}else if(t.isLine){const a="LineBasicMaterial:"+n.uuid;let l=this.cache.get(a);l||(l=new di,dn.prototype.copy.call(l,n),l.color.copy(n.color),l.map=n.map,this.cache.add(a,l)),n=l}if(i||r||o){let a="ClonedMaterial:"+n.uuid+":";i&&(a+="derivative-tangents:"),r&&(a+="vertex-colors:"),o&&(a+="flat-shading:");let l=this.cache.get(a);l||(l=n.clone(),r&&(l.vertexColors=!0),o&&(l.flatShading=!0),i&&(l.normalScale&&(l.normalScale.y*=-1),l.clearcoatNormalScale&&(l.clearcoatNormalScale.y*=-1)),this.cache.add(a,l),this.associations.set(l,this.associations.get(n))),n=l}t.material=n}getMaterialType(){return Ss}loadMaterial(t){const e=this,n=this.json,i=this.extensions,r=n.materials[t];let o;const a={},l=r.extensions||{},c=[];if(l[qt.KHR_MATERIALS_UNLIT]){const h=i[qt.KHR_MATERIALS_UNLIT];o=h.getMaterialType(),c.push(h.extendParams(a,r,e))}else{const h=r.pbrMetallicRoughness||{};if(a.color=new ut(1,1,1),a.opacity=1,Array.isArray(h.baseColorFactor)){const d=h.baseColorFactor;a.color.setRGB(d[0],d[1],d[2],Xe),a.opacity=d[3]}h.baseColorTexture!==void 0&&c.push(e.assignTexture(a,"map",h.baseColorTexture,Te)),a.metalness=h.metallicFactor!==void 0?h.metallicFactor:1,a.roughness=h.roughnessFactor!==void 0?h.roughnessFactor:1,h.metallicRoughnessTexture!==void 0&&(c.push(e.assignTexture(a,"metalnessMap",h.metallicRoughnessTexture)),c.push(e.assignTexture(a,"roughnessMap",h.metallicRoughnessTexture))),o=this._invokeOne(function(d){return d.getMaterialType&&d.getMaterialType(t)}),c.push(Promise.all(this._invokeAll(function(d){return d.extendMaterialParams&&d.extendMaterialParams(t,a)})))}r.doubleSided===!0&&(a.side=Pe);const u=r.alphaMode||ma.OPAQUE;if(u===ma.BLEND?(a.transparent=!0,a.depthWrite=!1):(a.transparent=!1,u===ma.MASK&&(a.alphaTest=r.alphaCutoff!==void 0?r.alphaCutoff:.5)),r.normalTexture!==void 0&&o!==qn&&(c.push(e.assignTexture(a,"normalMap",r.normalTexture)),a.normalScale=new Z(1,1),r.normalTexture.scale!==void 0)){const h=r.normalTexture.scale;a.normalScale.set(h,h)}if(r.occlusionTexture!==void 0&&o!==qn&&(c.push(e.assignTexture(a,"aoMap",r.occlusionTexture)),r.occlusionTexture.strength!==void 0&&(a.aoMapIntensity=r.occlusionTexture.strength)),r.emissiveFactor!==void 0&&o!==qn){const h=r.emissiveFactor;a.emissive=new ut().setRGB(h[0],h[1],h[2],Xe)}return r.emissiveTexture!==void 0&&o!==qn&&c.push(e.assignTexture(a,"emissiveMap",r.emissiveTexture,Te)),Promise.all(c).then(function(){const h=new o(a);return r.name&&(h.name=r.name),kn(h,r),e.associations.set(h,{materials:t}),r.extensions&&bi(i,h,r),h})}createUniqueName(t){const e=le.sanitizeNodeName(t||"");return e in this.nodeNamesUsed?e+"_"+ ++this.nodeNamesUsed[e]:(this.nodeNamesUsed[e]=0,e)}loadGeometries(t){const e=this,n=this.extensions,i=this.primitiveCache;function r(a){return n[qt.KHR_DRACO_MESH_COMPRESSION].decodePrimitive(a,e).then(function(l){return Bh(l,a,e)})}const o=[];for(let a=0,l=t.length;a<l;a++){const c=t[a],u=Nx(c),h=i[u];if(h)o.push(h.promise);else{let d;c.extensions&&c.extensions[qt.KHR_DRACO_MESH_COMPRESSION]?d=r(c):d=Bh(new ue,c,e),i[u]={primitive:c,promise:d},o.push(d)}}return Promise.all(o)}loadMesh(t){const e=this,n=this.json,i=this.extensions,r=n.meshes[t],o=r.primitives,a=[];for(let l=0,c=o.length;l<c;l++){const u=o[l].material===void 0?Lx(this.cache):this.getDependency("material",o[l].material);a.push(u)}return a.push(e.loadGeometries(o)),Promise.all(a).then(function(l){const c=l.slice(0,l.length-1),u=l[l.length-1],h=[];for(let f=0,g=u.length;f<g;f++){const _=u[f],m=o[f];let p;const b=c[f];if(m.mode===an.TRIANGLES||m.mode===an.TRIANGLE_STRIP||m.mode===an.TRIANGLE_FAN||m.mode===void 0)p=r.isSkinnedMesh===!0?new v_(_,b):new ne(_,b),p.isSkinnedMesh===!0&&p.normalizeSkinWeights(),m.mode===an.TRIANGLE_STRIP?p.geometry=Uh(p.geometry,nu):m.mode===an.TRIANGLE_FAN&&(p.geometry=Uh(p.geometry,sl));else if(m.mode===an.LINES)p=new Ai(_,b);else if(m.mode===an.LINE_STRIP)p=new Ul(_,b);else if(m.mode===an.LINE_LOOP)p=new M_(_,b);else if(m.mode===an.POINTS)p=new Fl(_,b);else throw new Error("THREE.GLTFLoader: Primitive mode unsupported: "+m.mode);Object.keys(p.geometry.morphAttributes).length>0&&Ux(p,r),p.name=e.createUniqueName(r.name||"mesh_"+t),kn(p,r),m.extensions&&bi(i,p,m),e.assignFinalMaterial(p),h.push(p)}for(let f=0,g=h.length;f<g;f++)e.associations.set(h[f],{meshes:t,primitives:f});if(h.length===1)return r.extensions&&bi(i,h[0],r),h[0];const d=new je;r.extensions&&bi(i,d,r),e.associations.set(d,{meshes:t});for(let f=0,g=h.length;f<g;f++)d.add(h[f]);return d})}loadCamera(t){let e;const n=this.json.cameras[t],i=n[n.type];if(!i){console.warn("THREE.GLTFLoader: Missing camera parameters.");return}return n.type==="perspective"?e=new ye(vs.radToDeg(i.yfov),i.aspectRatio||1,i.znear||1,i.zfar||2e6):n.type==="orthographic"&&(e=new ys(-i.xmag,i.xmag,i.ymag,-i.ymag,i.znear,i.zfar)),n.name&&(e.name=this.createUniqueName(n.name)),kn(e,n),Promise.resolve(e)}loadSkin(t){const e=this.json.skins[t],n=[];for(let i=0,r=e.joints.length;i<r;i++)n.push(this._loadNodeShallow(e.joints[i]));return e.inverseBindMatrices!==void 0?n.push(this.getDependency("accessor",e.inverseBindMatrices)):n.push(null),Promise.all(n).then(function(i){const r=i.pop(),o=i,a=[],l=[];for(let c=0,u=o.length;c<u;c++){const h=o[c];if(h){a.push(h);const d=new zt;r!==null&&d.fromArray(r.array,c*16),l.push(d)}else console.warn('THREE.GLTFLoader: Joint "%s" could not be found.',e.joints[c])}return new Il(a,l)})}loadAnimation(t){const e=this.json,n=this,i=e.animations[t],r=i.name?i.name:"animation_"+t,o=[],a=[],l=[],c=[],u=[];for(let h=0,d=i.channels.length;h<d;h++){const f=i.channels[h],g=i.samplers[f.sampler],_=f.target,m=_.node,p=i.parameters!==void 0?i.parameters[g.input]:g.input,b=i.parameters!==void 0?i.parameters[g.output]:g.output;_.node!==void 0&&(o.push(this.getDependency("node",m)),a.push(this.getDependency("accessor",p)),l.push(this.getDependency("accessor",b)),c.push(g),u.push(_))}return Promise.all([Promise.all(o),Promise.all(a),Promise.all(l),Promise.all(c),Promise.all(u)]).then(function(h){const d=h[0],f=h[1],g=h[2],_=h[3],m=h[4],p=[];for(let b=0,x=d.length;b<x;b++){const v=d[b],C=f[b],T=g[b],E=_[b],A=m[b];if(v===void 0)continue;v.updateMatrix&&v.updateMatrix();const M=n._createAnimationTracks(v,C,T,E,A);if(M)for(let y=0;y<M.length;y++)p.push(M[y])}return new lv(r,void 0,p)})}createNodeMesh(t){const e=this.json,n=this,i=e.nodes[t];return i.mesh===void 0?null:n.getDependency("mesh",i.mesh).then(function(r){const o=n._getNodeRef(n.meshCache,i.mesh,r);return i.weights!==void 0&&o.traverse(function(a){if(a.isMesh)for(let l=0,c=i.weights.length;l<c;l++)a.morphTargetInfluences[l]=i.weights[l]}),o})}loadNode(t){const e=this.json,n=this,i=e.nodes[t],r=n._loadNodeShallow(t),o=[],a=i.children||[];for(let c=0,u=a.length;c<u;c++)o.push(n.getDependency("node",a[c]));const l=i.skin===void 0?Promise.resolve(null):n.getDependency("skin",i.skin);return Promise.all([r,Promise.all(o),l]).then(function(c){const u=c[0],h=c[1],d=c[2];d!==null&&u.traverse(function(f){f.isSkinnedMesh&&f.bind(d,Ox)});for(let f=0,g=h.length;f<g;f++)u.add(h[f]);return u})}_loadNodeShallow(t){const e=this.json,n=this.extensions,i=this;if(this.nodeCache[t]!==void 0)return this.nodeCache[t];const r=e.nodes[t],o=r.name?i.createUniqueName(r.name):"",a=[],l=i._invokeOne(function(c){return c.createNodeMesh&&c.createNodeMesh(t)});return l&&a.push(l),r.camera!==void 0&&a.push(i.getDependency("camera",r.camera).then(function(c){return i._getNodeRef(i.cameraCache,r.camera,c)})),i._invokeAll(function(c){return c.createNodeAttachment&&c.createNodeAttachment(t)}).forEach(function(c){a.push(c)}),this.nodeCache[t]=Promise.all(a).then(function(c){let u;if(r.isBone===!0?u=new xu:c.length>1?u=new je:c.length===1?u=c[0]:u=new ie,u!==c[0])for(let h=0,d=c.length;h<d;h++)u.add(c[h]);if(r.name&&(u.userData.name=r.name,u.name=o),kn(u,r),r.extensions&&bi(n,u,r),r.matrix!==void 0){const h=new zt;h.fromArray(r.matrix),u.applyMatrix4(h)}else r.translation!==void 0&&u.position.fromArray(r.translation),r.rotation!==void 0&&u.quaternion.fromArray(r.rotation),r.scale!==void 0&&u.scale.fromArray(r.scale);return i.associations.has(u)||i.associations.set(u,{}),i.associations.get(u).nodes=t,u}),this.nodeCache[t]}loadScene(t){const e=this.extensions,n=this.json.scenes[t],i=this,r=new je;n.name&&(r.name=i.createUniqueName(n.name)),kn(r,n),n.extensions&&bi(e,r,n);const o=n.nodes||[],a=[];for(let l=0,c=o.length;l<c;l++)a.push(i.getDependency("node",o[l]));return Promise.all(a).then(function(l){for(let u=0,h=l.length;u<h;u++)r.add(l[u]);const c=u=>{const h=new Map;for(const[d,f]of i.associations)(d instanceof dn||d instanceof Be)&&h.set(d,f);return u.traverse(d=>{const f=i.associations.get(d);f!=null&&h.set(d,f)}),h};return i.associations=c(r),r})}_createAnimationTracks(t,e,n,i,r){const o=[],a=t.name?t.name:t.uuid,l=[];ci[r.path]===ci.weights?t.traverse(function(d){d.morphTargetInfluences&&l.push(d.name?d.name:d.uuid)}):l.push(a);let c;switch(ci[r.path]){case ci.weights:c=bs;break;case ci.rotation:c=ws;break;case ci.position:case ci.scale:c=Ts;break;default:switch(n.itemSize){case 1:c=bs;break;case 2:case 3:default:c=Ts;break}break}const u=i.interpolation!==void 0?Dx[i.interpolation]:rr,h=this._getArrayFromAccessor(n);for(let d=0,f=l.length;d<f;d++){const g=new c(l[d]+"."+ci[r.path],e.array,h,u);i.interpolation==="CUBICSPLINE"&&this._createCubicSplineTrackInterpolant(g),o.push(g)}return o}_getArrayFromAccessor(t){let e=t.array;if(t.normalized){const n=ml(e.constructor),i=new Float32Array(e.length);for(let r=0,o=e.length;r<o;r++)i[r]=e[r]*n;e=i}return e}_createCubicSplineTrackInterpolant(t){t.createInterpolant=function(n){const i=this instanceof ws?Px:Fu;return new i(this.times,this.values,this.getValueSize()/3,n)},t.createInterpolant.isInterpolantFactoryMethodGLTFCubicSpline=!0}}function zx(s,t,e){const n=t.attributes,i=new ti;if(n.POSITION!==void 0){const a=e.json.accessors[n.POSITION],l=a.min,c=a.max;if(l!==void 0&&c!==void 0){if(i.set(new P(l[0],l[1],l[2]),new P(c[0],c[1],c[2])),a.normalized){const u=ml(hs[a.componentType]);i.min.multiplyScalar(u),i.max.multiplyScalar(u)}}else{console.warn("THREE.GLTFLoader: Missing min/max properties for accessor POSITION.");return}}else return;const r=t.targets;if(r!==void 0){const a=new P,l=new P;for(let c=0,u=r.length;c<u;c++){const h=r[c];if(h.POSITION!==void 0){const d=e.json.accessors[h.POSITION],f=d.min,g=d.max;if(f!==void 0&&g!==void 0){if(l.setX(Math.max(Math.abs(f[0]),Math.abs(g[0]))),l.setY(Math.max(Math.abs(f[1]),Math.abs(g[1]))),l.setZ(Math.max(Math.abs(f[2]),Math.abs(g[2]))),d.normalized){const _=ml(hs[d.componentType]);l.multiplyScalar(_)}a.max(l)}else console.warn("THREE.GLTFLoader: Missing min/max properties for accessor POSITION.")}}i.expandByVector(a)}s.boundingBox=i;const o=new Rn;i.getCenter(o.center),o.radius=i.min.distanceTo(i.max)/2,s.boundingSphere=o}function Bh(s,t,e){const n=t.attributes,i=[];function r(o,a){return e.getDependency("accessor",o).then(function(l){s.setAttribute(a,l)})}for(const o in n){const a=pl[o]||o.toLowerCase();a in s.attributes||i.push(r(n[o],a))}if(t.indices!==void 0&&!s.index){const o=e.getDependency("accessor",t.indices).then(function(a){s.setIndex(a)});i.push(o)}return Kt.workingColorSpace!==Xe&&"COLOR_0"in n&&console.warn(`THREE.GLTFLoader: Converting vertex colors from "srgb-linear" to "${Kt.workingColorSpace}" not supported.`),kn(s,t),zx(s,t,e),Promise.all(i).then(function(){return t.targets!==void 0?Ix(s,t.targets,e):s})}const kx={},zh={genjin:{type:"stem",growStart:0,growEnd:.4},left1:{type:"leaf",growStart:.08,growEnd:.45},left2:{type:"leaf",growStart:.12,growEnd:.48},left3:{type:"leaf",growStart:.15,growEnd:.5},huarui:{type:"pistil",growStart:.35,growEnd:.6},huaban1:{type:"petal",growStart:.38,growEnd:.85,order:0},huaban4:{type:"petal",growStart:.41,growEnd:.87,order:1},huaban2:{type:"petal",growStart:.44,growEnd:.89,order:2},huaban5:{type:"petal",growStart:.47,growEnd:.91,order:3},huaban3:{type:"petal",growStart:.5,growEnd:.93,order:4},huaban6:{type:"petal",growStart:.53,growEnd:.95,order:5}};function _a(s){return 1-Math.pow(1-s,3)}function va(s){return 1+2.7*Math.pow(s-1,3)+1.7*Math.pow(s-1,2)}class Vx{constructor(t={}){this.options={autoPlay:!0,growthDuration:8,loopMode:"loop",petalOpenAngle:.3,petalScale:1,petalCurl:.4,stemHeight:1,stemBend:.05,leafScale:1,leafDroop:.2,windStrength:1,windSpeed:.5,sssStrength:.3,cameraDistance:3.5,autoRotateSpeed:.01,mouseParallaxH:.3,mouseParallaxV:.15,smoothFactor:.04,activeTab:1,...t},this._group=new je,this._group.position.set(0,-.15,0),this._clock=new Fi,this._time=0,this._mouse={x:0,y:0},this._target={x:0,y:0},this._bgMesh=null,this._bgMat=null,this._lightGroup=new je,this._loaded=!1,this._parts=new Map,this.camera=new ye(45,window.innerWidth/window.innerHeight,.1,100),this.camera.position.set(0,.2,.8)}build(){return this._createBackground(),this._createLights(),this._loadModel(),this}addTo(t){return t.add(this._group),t.add(this._lightGroup),this._bgMesh&&t.add(this._bgMesh),this}setMouse(t,e){this._mouse.x=(t/window.innerWidth-.5)*2,this._mouse.y=(e/window.innerHeight-.5)*2}update(){const t=this._clock.getDelta(),e=this.options;this._time+=t;const n=this._time;if(this._target.x+=(this._mouse.x*e.mouseParallaxH-this._target.x)*e.smoothFactor,this._target.y+=(-this._mouse.y*e.mouseParallaxV-this._target.y)*e.smoothFactor,this.camera.position.x=Math.sin(e.autoRotateSpeed*n+this._target.x)*e.cameraDistance*.23,this.camera.position.z=Math.cos(e.autoRotateSpeed*n+this._target.x)*e.cameraDistance*.23,this.camera.position.y=.15+this._target.y,this.camera.lookAt(0,.08,0),this._bgMat&&(this._bgMat.uniforms.uTime.value+=t),!this._loaded)return;let i;if(e.autoPlay){const r=e.growthDuration;if(e.loopMode==="loop")i=n%r/r;else if(e.loopMode==="pingpong"){const o=n%(r*2)/r;i=o<=1?o:2-o}else i=Math.min(n/r,1)}else i=Math.max(0,Math.min(1,e.growthProgress||0));this._animateParts(i,n)}resize(t,e){this.camera.aspect=t/e,this.camera.updateProjectionMatrix()}dispose(){this._group.traverse(t=>{t.geometry&&t.geometry.dispose(),t.material&&(Array.isArray(t.material)?t.material.forEach(e=>e.dispose()):t.material.dispose())}),this._group.parent&&this._group.parent.remove(this._group),this._lightGroup.parent&&this._lightGroup.parent.remove(this._lightGroup),this._bgMesh&&(this._bgMesh.geometry.dispose(),this._bgMat.dispose(),this._bgMesh.parent&&this._bgMesh.parent.remove(this._bgMesh))}_loadModel(){const t=new Uu,e=new Cu,n=typeof kx<"u"&&"/3DProcedural_Ecosystem/"||"/",i=e.load(n+"model/color.png");i.flipY=!0,i.colorSpace=Te;const r=e.load(n+"model/roughness.png");r.flipY=!0,t.load(n+"model/tulip-split.glb",o=>{const a=o.scene.clone(!0);a.traverse(l=>{if(!l.isMesh)return;const c=zh[l.name],u=new Ss({map:i,roughnessMap:r,roughness:.55,metalness:0,side:Pe,transparent:!0,opacity:0,envMapIntensity:.3});l.material=u,l.castShadow=!0,l.receiveShadow=!0;let h=null,d=0,f=0,g=1;if(c&&(c.type==="petal"||c.type==="leaf")){l.geometry=l.geometry.clone();const _=l.geometry.getAttribute("position");h=new Float32Array(_.array);let m=1/0,p=-1/0;for(let b=0;b<_.count;b++){const x=h[b*3+2];x<m&&(m=x),x>p&&(p=x)}d=m,f=p,g=p-m||1}this._parts.set(l.name,{mesh:l,initPos:l.position.clone(),initQuat:l.quaternion.clone(),initScale:l.scale.clone(),mat:u,origPositions:h,zMin:d,zMax:f,zRange:g})}),this._group.add(a),this._loaded=!0})}_createLights(){const t=new mi(15261936,.6),e=new cs(16774638,1.8);e.position.set(3,5,2),e.castShadow=!0;const n=new cs(13682943,.7);n.position.set(-2,4,-3);const i=new cs(15788287,.3);i.position.set(0,-1,2);const r=new Ls(16766176,.8,2,2);r.position.set(0,.25,.15);const o=new gv(12110079,2767386,.35);this._lightGroup.add(t,e,n,i,r,o)}_createBackground(){this._bgMat=new ge({depthWrite:!1,depthTest:!1,uniforms:{uTime:{value:0}},vertexShader:`
        varying vec2 vUv;
        void main() { vUv = uv; gl_Position = vec4(position.xy, 0.9999, 1.0); }
      `,fragmentShader:Hx}),this._bgMesh=new ne(new fn(2,2),this._bgMat),this._bgMesh.renderOrder=-1,this._bgMesh.frustumCulled=!1}_animateParts(t,e){const n=this.options,i=Math.sin(e*n.windSpeed*.4)*n.windStrength,r=Math.cos(e*n.windSpeed*.3+1.5)*n.windStrength;this._parts.forEach((a,l)=>{const{mesh:c,initPos:u,initQuat:h,initScale:d,mat:f,origPositions:g,zMin:_,zRange:m}=a,p=zh[l];if(!p)return;const b=Math.max(0,Math.min(1,(t-p.growStart)/(p.growEnd-p.growStart))),x=p.order||0;if(c.position.copy(u),c.quaternion.copy(h),c.scale.copy(d),g){const v=c.geometry.getAttribute("position");v.array.set(g),v.needsUpdate=!0}this._animateGrowth(c,f,p,b,x,e,i,r,g,_,m),c.visible=b>.001});const o=Math.min(3*t,1);this._group.rotation.y=0,this._group.rotation.z=.003*i*o,this._group.rotation.x=.002*r*o}_animateGrowth(t,e,n,i,r,o,a,l,c,u,h){const d=this.options;if(n.type==="stem"){const f=_a(i);t.scale.set(t.scale.x*(.3+.7*f),t.scale.y*Math.max(.001,f),t.scale.z*(.3+.7*f)),e.opacity=Math.min(i*5,1),f>.3&&(t.rotateZ(.003*a*f),t.rotateX(.002*l*f))}else if(n.type==="leaf"){const f=va(i);t.scale.multiplyScalar(Math.max(.001,f)),e.opacity=Math.min(i*4,1),t.rotateY((1-f)*.6),t.rotateX((1-f)*.18),f>.3&&t.rotateZ(.008*Math.sin(o*d.windSpeed*.6+t.id*2)*d.windStrength*f)}else if(n.type==="pistil")e.opacity=_a(Math.min(i*2.5,1));else if(n.type==="petal"){e.opacity=_a(Math.min(i*2.5,1));const f=Math.max(.001,va(Math.min(i/.5,1)));t.scale.multiplyScalar(f);const g=va(Math.min(Math.max((i-.25)/.75,0),1)),_=1-g;if(_>.005&&(t.rotateX(-(.5*_)),t.rotateY(.08*_*(r%2===0?1:-1))),c&&h){const m=t.geometry.getAttribute("position"),p=m.array;let b=Math.min(i/.65,1);const v=1-(b<.5?4*b*b*b:1-Math.pow(-2*b+2,3)/2);for(let C=0;C<m.count;C++){const T=c[C*3+2],E=(T-u)/h;p[C*3+2]=T+E*E*v*3.5}m.needsUpdate=!0}if(g>.7){const m=(g-.7)/.3;t.rotateX(.005*Math.sin(o*(1+r*.18)+r*1.5)*m*d.windStrength),t.rotateZ(.004*Math.sin(o*(.7+r*.13)+r*2.1)*m*d.windStrength)}}}}const Hx=`
  uniform float uTime;
  varying vec2 vUv;
  float hash(vec2 p) {
    vec3 p3 = fract(vec3(p.xyx) * 0.1031);
...
`;continue}if((z=G.match(y))&&(B.gamma=parseFloat(z[1])),(z=G.match(D))&&(B.exposure=parseFloat(z[1])),(z=G.match(O))&&(B.valid|=2,B.format=z[1]),(z=G.match(F))&&(B.valid|=4,B.height=parseInt(z[1],10),B.width=parseInt(z[2],10)),B.valid&2&&B.valid&4)break}return B.valid&2||o(3,"missing format specifier"),B.valid&4||o(3,"missing image size specifier"),B},f=function(A,M,y){const D=M;if(D<8||D>32767||A[0]!==2||A[1]!==2||A[2]&128)return new Uint8Array(A);D!==(A[2]<<8|A[3])&&o(3,"wrong scanline width");const O=new Uint8Array(4*M*y);O.length||o(4,"unable to allocate buffer space");let F=0,B=0;const G=4*D,z=new Uint8Array(4),K=new Uint8Array(G);let W=y;for(;W>0&&B<A.byteLength;){B+4>A.byteLength&&o(1),z[0]=A[B++],z[1]=A[B++],z[2]=A[B++],z[3]=A[B++],(z[0]!=2||z[1]!=2||(z[2]<<8|z[3])!=D)&&o(3,"bad rgbe scanline format");let nt=0,st;for(;nt<G&&B<A.byteLength;){st=A[B++];const Ct=st>128;if(Ct&&(st-=128),(st===0||nt+st>G)&&o(3,"bad scanline data"),Ct){const Ut=A[B++];for(let q=0;q<st;q++)K[nt++]=Ut}else K.set(A.subarray(B,B+st),nt),nt+=st,B+=st}const pt=D;for(let Ct=0;Ct<pt;Ct++){let Ut=0;O[F]=K[Ct+Ut],Ut+=D,O[F+1]=K[Ct+Ut],Ut+=D,O[F+2]=K[Ct+Ut],Ut+=D,O[F+3]=K[Ct+Ut],F+=4}W--}return O},g=function(A,M,y,D){const O=A[M+3],F=Math.pow(2,O-128)/255;y[D+0]=A[M+0]*F,y[D+1]=A[M+1]*F,y[D+2]=A[M+2]*F,y[D+3]=1},_=function(A,M,y,D){const O=A[M+3],F=Math.pow(2,O-128)/255;y[D+0]=Pr.toHalfFloat(Math.min(A[M+0]*F,65504)),y[D+1]=Pr.toHalfFloat(Math.min(A[M+1]*F,65504)),y[D+2]=Pr.toHalfFloat(Math.min(A[M+2]*F,65504)),y[D+3]=Pr.toHalfFloat(1)},m=new Uint8Array(t);m.pos=0;const p=d(m),b=p.width,x=p.height,v=f(m.subarray(m.pos),b,x);let C,T,E;switch(this.type){case Le:E=v.length/4;const A=new Float32Array(E*4);for(let y=0;y<E;y++)g(v,y*4,A,y*4);C=A,T=Le;break;case sn:E=v.length/4;const M=new Uint16Array(E*4);for(let y=0;y<E;y++)_(v,y*4,M,y*4);C=M,T=sn;break;default:throw new Error("THREE.RGBELoader: Unsupported type: "+this.type)}return{width:b,height:x,data:C,header:p.string,gamma:p.gamma,exposure:p.exposure,type:T}}setDataType(t){return this.type=t,this}load(t,e,n,i){function r(o,a){switch(o.type){case Le:case sn:o.colorSpace=Xe,o.minFilter=Me,o.magFilter=Me,o.generateMipmaps=!1,o.flipY=!0;break}e&&e(o,a)}return super.load(t,r,n,i)}}const Wx={};class Xx{constructor(){this.name="Bloom",this.category="flora",this._clock=new Fi,this._loaded=!1,this._renderer=null,this._scene=null,this._camera=null,this._group=null,this._petalMesh=null,this._stemMesh=null,this._particles=null,this._startProgress=0,this._groupRotY=0,this._animStartTime=-1,this._pointer=new Z(0,0),this._distortRT1=null,this._distortRT2=null,this._distortPhase=!1,this._distortScene=null,this._distortCamera=null,this._distortMat=null,this._lastNDC=new Z(.5,.5),this._currNDC=new Z(.5,.5),this._pointerDiff=0,this._isPointerEnter=!1,this._compScene=null,this._compCamera=null,this._compMat=null,this._mainRT=null,this._uStartProgress={value:0},this._uTime={value:0},this._uCycleDuration={value:6},this._uScaleMinY={value:.01},this._uScaleMaxY={value:.7},this._uScaleMinZ={value:.3},this._uScaleMaxZ={value:.4},this._uBendMin={value:1},this._uBendMax={value:-2},this._params={particleGravity:.0098,distortStrength:.05}}getCamera(){return this._camera}getLights(){return[]}getBackground(){return null}async init(t,e){this._renderer=e,this._scene=new ls,this._createHTMLBackground(e),this._camera=new ye(75,window.innerWidth/window.innerHeight,.1,100),this._camera.position.set(0,2,0),this._camera.zoom=2.5,this._camera.updateProjectionMatrix(),this._camera.lookAt(0,0,0),this._group=new je,this._group.rotation.y=0,this._scene.add(this._group),await this._loadAssets(e),this._setupDistortion(e),this._setupComposite(e),this._bindPointer(e),e.toneMapping=En,this._animStartTime=this._clock.getElapsedTime(),this._loaded=!0}async _loadAssets(t){const e=new Uu,n=new Gx,i=typeof Wx<"u"&&"/3DProcedural_Ecosystem/"||"/",[r,o,a]=await Promise.all([new Promise((g,_)=>e.load(i+"model/bloom-petal.glb",g,void 0,_)),new Promise((g,_)=>e.load(i+"model/bloom-stem.glb",g,void 0,_)),new Promise((g,_)=>n.load(i+"model/dawn.hdr",g,void 0,_))]),l=new al(t);l.compileEquirectangularShader();const c=l.fromEquirectangular(a);this._scene.environment=c.texture,this._scene.environmentIntensity=.8,this._scene.environmentRotation=new Qe(0,-Math.PI/1.5,0),a.dispose(),l.dispose();const u=o.scene;u.position.set(0,-3.3,-.03),u.scale.setScalar(.8),u.traverse(g=>{g.isMesh&&(g.material=new Ss({roughness:.5,color:"#ffffff"}))}),this._group.add(u),this._stemMesh=u,this._setupPetals(r);const h=new Ls(15658751,4,10,1);h.position.set(0,2,.3),this._group.add(h),this._pointLight=h;const d=new cs(14540543,.8);d.position.set(0,1,3),d.lookAt(0,0,0),this._scene.add(d);const f=new mi(6316160,.4);this._scene.add(f),this._ambientLight=f,this._setupParticles()}_setupPetals(t){let e=null,n=null;if(t.scene.traverse(c=>{c.isMesh&&!e&&(e=c.geometry,n=c.material)}),!e)return;const i=new Ss({side:Pe,map:n.map,normalMap:n.normalMap,emissiveMap:n.emissiveMap,emissive:new ut(1,1,1),emissiveIntensity:.8,roughness:.35,metalness:.05,envMapIntensity:1.5,normalScale:new Z(1,1)});i.map&&(i.map.colorSpace=Te),i.emissiveMap&&(i.emissiveMap.colorSpace=Te);const r=this._uStartProgress,o=this._uTime;i.onBeforeCompile=c=>{c.uniforms.uStartProgress=r,c.uniforms.uTime=o,c.uniforms.uCycleDuration=this._uCycleDuration,c.uniforms.uScaleMinY=this._uScaleMinY,c.uniforms.uScaleMaxY=this._uScaleMaxY,c.uniforms.uScaleMinZ=this._uScaleMinZ,c.uniforms.uScaleMaxZ=this._uScaleMaxZ,c.uniforms.uBendMin=this._uBendMin,c.uniforms.uBendMax=this._uBendMax,c.vertexShader=c.vertexShader.replace("#include <common>",`
        ...
        `)};const a=new gr(e,i,128),l=new ie;for(let c=0;c<128;c++)l.rotation.set(0,vs.degToRad(140*c),0),l.updateMatrix(),a.setMatrixAt(c,l.matrix);a.instanceMatrix.needsUpdate=!0,this._group.add(a),this._petalMesh=a}_setupParticles(){const n=new Float32Array(1200),i=new Float32Array(400*3),r=new Float32Array(400);for(let l=0;l<400;l++)n[l*3]=(Math.random()-.5)*20,n[l*3+1]=(Math.random()-.5)*20,n[l*3+2]=(Math.random()-.5)*20,r[l]=Math.random();const o=new ue;o.setAttribute("position",new pe(n,3)),o.setAttribute("aPhase",new pe(r,1)),this._particleVel=i;const a=new ge({uniforms:{uTime:{value:0}},vertexShader:`
      ...
      `});const r=new ne(new fn(2,2),this._distortMat);this._distortScene.add(r)}_setupComposite(t){const e=window.innerWidth,n=window.innerHeight;this._mainRT=new ke(e,n,{minFilter:Me,magFilter:Me,format:Oe}),this._compScene=new ls,this._compCamera=new ys(-1,1,1,-1,0,1),this._compMat=new ge({uniforms:{tScene:{value:null},tDistort:{value:null},uDistortStrength:{value:.05}},vertexShader:`
        varying vec2 vUv;
        void main() { vUv = uv; gl_Position = vec4(position, 1.0); }
      `,fragmentShader:`
      ...
      `,transparent:!0});const i=new ne(new fn(2,2),this._compMat);this._compScene.add(i)}_bindPointer(t){const e=t.domElement;this._onMove=n=>{const i=e.getBoundingClientRect(),r=(n.clientX-i.left)/i.width*2-1,o=-((n.clientY-i.top)/i.height)*2+1;this._pointer.set(r,o);const a=.5*r+.5,l=.5*o+.5;this._lastNDC.copy(this._currNDC),this._currNDC.set(a,l);const c=this._currNDC.x-this._lastNDC.x,u=this._currNDC.y-this._lastNDC.y;this._pointerDiff=Math.sqrt(c*c+u*u)},this._isPointerEnter=!0,e.addEventListener("pointermove",this._onMove)}_createHTMLBackground(t){const e=t.domElement,n=e.parentElement;t.setClearColor(0,0),this._bgDiv=document.createElement("div"),this._bgDiv.id="bloom-bg",this._bgDiv.style.cssText=`
      position:absolute; inset:0; z-index:-2;
      background:linear-gradient(to bottom, #000000, #8386ff);
      pointer-events:none;
    `,n.style.position="relative",n.insertBefore(this._bgDiv,e),this._starsDiv=document.createElement("div"),this._starsDiv.id="bloom-stars",this._starsDiv.style.cssText=`
      position:absolute; inset:0; z-index:-1;
      pointer-events:none; overflow:hidden;
    `,n.insertBefore(this._starsDiv,e);const i=120;for(let r=0;r<i;r++){const o=document.createElement("div"),a=Math.random()*2.5+.5,l=Math.random()*100,c=Math.random()*100,u=Math.random()*5,h=2+Math.random()*4,d=.2+Math.random()*.6;o.style.cssText=`
        position:absolute;
        left:${l}%; top:${c}%;
    ...
    `}}class Ou extends Is{constructor(t={}){super({power:8,iterations:12,bailout:2,scale:2,colorA:[.1,.2,.6],colorB:[.9,.3,.1],glowIntensity:.5,animate:!0,...t})}_buildGeometry(){return new fn(2,2)}_buildMaterial(){const t=this._params,e=`
      precision highp float;
      out vec2 vUv;
      void main() {
        vUv = uv;
    ...
    `}}class Bu extends Is{constructor(t={}){super({colorTop:[.1,.8,.3],colorBottom:[.3,.1,.6],colorAccent:[.1,.3,.9],height:5,curtainWidth:15,speed:.3,intensity:1.5,turbulence:1,raySteps:48,...t})}_buildGeometry(){return new fn(2,2)}_buildMaterial(){const t=this._params,e=`
      precision highp float;
      out vec2 vUv;
      void main() {
        vUv = uv;
...
`;class Qx extends Us{getDefaults(){return{highlightColor:16761600,midtoneColor:16719616,lowlightColor:2949375,baseColor:16772075,blurFactor:.6,speed:1,zoom:1}}static get fragmentShader(){return iy}}class ty extends Us{getDefaults(){return{color1:35980,color2:15918901,backgroundColor:14155663,amplitudeFactor:1,ringFactor:1,rotationFactor:1,size:1.5,speed:1}}static get fragmentShader(){return sy}}class ey extends Us{getDefaults(){return{backgroundColor:16777215,skyColor:6863063,cloudColor:11387358,cloudShadowColor:1586512,sunColor:16750873,sunGlareColor:16737843,sunlightColor:16750899,speed:1}}static get fragmentShader(){return ry}}class ny extends Us{getDefaults(){return{color1:396069,color2:16777215,backgroundColor:16185078,amplitudeFactor:1,ringFactor:4,rotationFactor:.1,speed:1}}static get fragmentShader(){return oy}}const iy=`
uniform vec2 iResolution;
uniform vec2 iMouse;
uniform float iTime;
...
void main(){
  ...
  gl_FragColor=vec4(out1,1.);
        ...
        `;const st=nt.querySelector(".tc-slider"),pt=nt.querySelector(".tc-value"),Ct=z;st.addEventListener("input",()=>{const Ut=parseFloat(st.value);pt.textContent=_(Ut,Ct),b(O,Ut,!1)}),st.addEventListener("change",()=>{const Ut=parseFloat(st.value);b(O,Ut,!0)})}(y||M).appendChild(nt)}if(!T.isCanvas){const D=document.createElement("div");D.className="tc-group",D.innerHTML='<div class="tc-group-title">📷 相机</div>';const O=p("FOV",10,150,1,Fe.fov,B=>{Fe.fov=B,Fe.updateProjectionMatrix()});D.appendChild(O);const F=p("Z 距离",-500,500,1,Fe.position.z,B=>{Fe.position.z=B});D.appendChild(F),M.appendChild(D)}E.appendChild(M),r.appendChild(E)}function p(C,T,E,A,M,y){const D=document.createElement("div");D.className="tc-row",D.innerHTML=`
      <span class="tc-label">${C}</span>
      <input type="range" class="tc-slider" min="${T}" max="${E}" step="${A}" value="${M}">
      <span class="tc-value">${_(M,A)}</span>
    `;const O=D.querySelector(".tc-slider"),F=D.querySelector(".tc-value");return O.addEventListener("input",()=>{const B=parseFloat(O.value);F.textContent=_(B,A),y(B)}),D}function b(C,T,E){const A=tt,M=$e[Qt];if(!(!A||!M)){if(te[C]=T,M.isVanta&&A._uniforms){const y=A._uniforms;if(y[C])if(/color|background|tint|hue/i.test(C)&&typeof T=="number"){const D=new ut(T);y[C].value.set(D.r,D.g,D.b)}else y[C].value=T;A._params&&(A._params[C]=T);return}if(M.is3DVanta&&A.options){A.options[C]=T;return}if(M.isCanvas&&A._params){A._params[C]=T;return}if(Qt==="bloom"&&A.applyParam){A.applyParam(C,T);return}A._params&&(A._params[C]=T),A.options&&(A.options[C]=T),A._mesh&&x(A._mesh,C,T),A._group&&A._group.traverse(y=>{y.isMesh&&y.material&&y.material.uniforms&&x(y,C,T)}),E&&(Ii(Qt,te),setTimeout(()=>m(Qt),50))}}function x(C,T,E){if(!C.material)return;const A=Array.isArray(C.material)?C.material:[C.material];for(const M of A){if(!M.uniforms)continue;if(M.uniforms[T])if(/color/i.test(T)&&typeof E=="number"){const D=new ut(E);M.uniforms[T].value&&M.uniforms[T].value.isVector3?M.uniforms[T].value.set(D.r,D.g,D.b):M.uniforms[T].value=D}else typeof E=="number"&&(M.uniforms[T].value=E);const y="u"+T.charAt(0).toUpperCase()+T.slice(1);M.uniforms[y]&&typeof E=="number"&&(M.uniforms[y].value=E)}}o.addEventListener("click",()=>{const C={mode:Qt,params:{...te}};navigator.clipboard.writeText(JSON.stringify(C,null,2)).then(()=>{g("✅ 参数已复制到剪贴板")})}),c.addEventListener("click",()=>{const C={mode:Qt,params:{...te}};navigator.clipboard.writeText(JSON.stringify(C,null,2)).then(()=>{g("📋 JSON 已复制")})}),a.addEventListener("click",()=>{!f||!$e[f]||(te={...$e[f].defs},Ii(Qt,te),Kl(Qt),setTimeout(()=>m(Qt),50),g("↩ 已重置为默认值"))}),l.addEventListener("click",()=>{const C={mode:Qt,params:{...te}};localStorage.setItem("tc-3d-saved-"+Qt,JSON.stringify(C)),g("💾 已保存到本地")});const v=window.appSwitch;window.appSwitch=function(C){v(C);const T=localStorage.getItem("tc-3d-saved-"+C);if(T)try{const{params:E}=JSON.parse(T)}catch{}setTimeout(()=>m(C),80)},setTimeout(()=>m(Qt),200)})();
