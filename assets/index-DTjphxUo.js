...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Kn,depthTest:!1,depthWrite:!1})}function Oc(){return new ge({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Pl(),fragmentShader:`
		...
		`,blending:Kn,depthTest:!1,depthWrite:!1})}function zc(){return new ge({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Pl(),fragmentShader:`
	...
	`}function x0(s){let t=new WeakMap,e=null;function n(a){if(a&&a.isTexture){const l=a.mapping,c=l===Pa||l===Da,u=l===ds||l===fs;if(c||u){let h=t.get(a);const d=h!==void 0?h.texture.pmremVersion:0;if(a.isRenderTargetTexture&&a.pmremVersion!==d)return e===null&&(e=new al(s)),h=c?e.fromEquirectangular(a,h):e.fromCubemap(a,h),h.texture.pmremVersion=a.pmremVersion,t.set(a,h),h.texture;if(h!==void 0)return h.texture;{const f=a.image;return c&&f&&f.height>0||u&&f&&i(f)?(e===null&&(e=new al(s)),h=c?e.fromEquirectangular(a):e.fromCubemap(a),h.texture.pmremVersion=a.pmremVersion,t.set(a,h),a.addEventListener("dispose",r),h.texture):null}}}return a}function i(a){let l=0;const c=6;for(let u=0;u<c;u++)a[u]!==void 0&&l++;return l===c}function r(a){const l=a.target;l.removeEventListener("dispose",r);const c=t.get(l);c!==void 0&&(t.delete(l),c.dispose())}function o(){t=new WeakMap,e!==null&&(e.dispose(),e=null)}return{get:n,dispose:o}}function y0(s){const t={};function e(n){if(t[n]!==void 0)return t[n];let i;switch(n){case"WEBGL_depth_texture":i=s.getExtension("WEBGL_depth_texture")||s.getExtension("MOZ_WEBGL_depth_texture")||s.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":i=s.getExtension("EXT_texture_filter_anisotropic")||s.getExtension("MOZ_EXT_texture_filter_anisotropic")||s.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":i=s.getExtension("WEBGL_compressed_texture_s3tc")||s.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||s.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":i=s.getExtension("WEBGL_compressed_texture_pvrtc")||s.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:i=s.getExtension(n)}return t[n]=i,i}return{has:function(n){return e(n)!==null},init:function(){e("EXT_color_buffer_float"),e("WEBGL_clip_cull_distance"),e("OES_texture_float_linear"),e("EXT_color_buffer_half_float"),e("WEBGL_multisampled_render_to_texture"),e("WEBGL_render_shared_exponent")},get:function(n){const i=e(n);return i===null&&qs("THREE.WebGLRenderer: "+n+" extension not supported."),i}}}function M0(s,t,e,n){const i={},r=new WeakMap;function o(h){const d=h.target;d.index!==null&&t.remove(d.index);for(const g in d.attributes)t.remove(d.attributes[g]);for(const g in d.morphAttributes){const _=d.morphAttributes[g];for(let m=0,p=_.length;m<p;m++)t.remove(_[m])}d.removeEventListener("dispose",o),delete i[d.id];const f=r.get(d);f&&(t.remove(f),r.delete(d)),n.releaseStatesOfGeometry(d),d.isInstancedBufferGeometry===!0&&delete d._maxInstanceCount,e.memory.geometries--}function a(h,d){return i[d.id]===!0||(d.addEventListener("dispose",o),i[d.id]=!0,e.memory.geometries++),d}function l(h){const d=h.attributes;for(const g in d)t.update(d[g],s.ARRAY_BUFFER);const f=h.morphAttributes;for(const g in f){const _=f[g];for(let m=0,p=_.length;m<p;m++)t.update(_[m],s.ARRAY_BUFFER)}}function c(h){const d=[],f=h.index,g=h.attributes.position;let _=0;if(f!==null){const b=f.array;_=f.version;for(let x=0,v=b.length;x<v;x+=3){const C=b[x+0],T=b[x+1],E=b[x+2];d.push(C,T,T,E,E,C)}}else if(g!==void 0){const b=g.array;_=g.version;for(let x=0,v=b.length/3-1;x<v;x+=3){const C=x+0,T=x+1,E=x+2;d.push(C,T,T,E,E,C)}}else return;const m=new(su(d)?hu:cu)(d,1);m.version=_;const p=r.get(h);p&&t.remove(p),r.set(h,m)}function u(h){const d=r.get(h);if(d){const f=h.index;f!==null&&d.version<f.version&&c(h)}else c(h);return r.get(h)}return{get:a,update:l,getWireframeAttribute:u}}function S0(s,t,e){let n;function i(d){n=d}let r,o;function a(d){r=d.type,o=d.bytesPerElement}function l(d,f){s.drawElements(n,f,r,d*o),e.update(f,n,1)}function c(d,f,g){g!==0&&(s.drawElementsInstanced(n,f,r,d*o,g),e.update(f,n,g))}function u(d,f,g){if(g===0)return;t.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,f,0,r,d,0,g);let m=0;for(let p=0;p<g;p++)m+=f[p];e.update(m,n,1)}function h(d,f,g,_){if(g===0)return;const m=t.get("WEBGL_multi_draw");if(m===null)for(let p=0;p<d.length;p++)c(d[p]/o,f[p],_[p]);else{m.multiDrawElementsInstancedWEBGL(n,f,0,r,d,0,_,0,g);let p=0;for(let b=0;b<g;b++)p+=f[b]*_[b];e.update(p,n,1)}}this.setMode=i,this.setIndex=a,this.render=l,this.renderInstances=c,this.renderMultiDraw=u,this.renderMultiDrawInstances=h}function b0(s){const t={geometries:0,textures:0},e={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,o,a){switch(e.calls++,o){case s.TRIANGLES:e.triangles+=a*(r/3);break;case s.LINES:e.lines+=a*(r/2);break;case s.LINE_STRIP:e.lines+=a*(r-1);break;case s.LINE_LOOP:e.lines+=a*r;break;case s.POINTS:e.points+=a*r;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",o);break}}function i(){e.calls=0,e.triangles=0,e.points=0,e.lines=0}return{memory:t,render:e,programs:null,autoReset:!0,reset:i,update:n}}function w0(s,t,e){const n=new WeakMap,i=new ee;function r(o,a,l){const c=o.morphTargetInfluences,u=a.morphAttributes.position||a.morphAttributes.normal||a.morphAttributes.color,h=u!==void 0?u.length:0;let d=n.get(a);if(d===void 0||d.count!==h){let y=function(){A.dispose(),n.delete(a),a.removeEventListener("dispose",y)};var f=y;d!==void 0&&d.texture.dispose();const g=a.morphAttributes.position!==void 0,_=a.morphAttributes.normal!==void 0,m=a.morphAttributes.color!==void 0,p=a.morphAttributes.position||[],b=a.morphAttributes.normal||[],x=a.morphAttributes.color||[];let v=0;g===!0&&(v=1),_===!0&&(v=2),m===!0&&(v=3);let C=a.attributes.position.count*v,T=1;C>t.maxTextureSize&&(T=Math.ceil(C/t.maxTextureSize),C=t.maxTextureSize);const E=new Float32Array(C*T*4*h),A=new ou(E,C,T,h);A.type=Le,A.needsUpdate=!0;const M=v*4;for(let D=0;D<h;D++){const O=p[D],F=b[D],z=x[D],G=C*T*4*D;for(let B=0;B<O.count;B++){const K=B*M;g===!0&&(i.fromBufferAttribute(O,B),E[G+K+0]=i.x,E[G+K+1]=i.y,E[G+K+2]=i.z,E[G+K+3]=0),_===!0&&(i.fromBufferAttribute(F,B),E[G+K+4]=i.x,E[G+K+5]=i.y,E[G+K+6]=i.z,E[G+K+7]=0),m===!0&&(i.fromBufferAttribute(z,B),E[G+K+8]=i.x,E[G+K+9]=i.y,E[G+K+10]=i.z,E[G+K+11]=z.itemSize===4?i.w:1)}}d={count:h,texture:A,size:new Z(C,T)},n.set(a,d),a.addEventListener("dispose",y)}if(o.isInstancedMesh===!0&&o.morphTexture!==null)l.getUniforms().setValue(s,"morphTexture",o.morphTexture,e);else{let g=0;for(let m=0;m<c.length;m++)g+=c[m];const _=a.morphTargetsRelative?1:1-g;l.getUniforms().setValue(s,"morphTargetBaseInfluence",_),l.getUniforms().setValue(s,"morphTargetInfluences",c)}l.getUniforms().setValue(s,"morphTargetsTexture",d.texture,e),l.getUniforms().setValue(s,"morphTargetsTextureSize",d.size)}return{update:r}}function T0(s,t,e,n){let i=new WeakMap;function r(l){const c=n.render.frame,u=l.geometry,h=t.get(l,u);if(i.get(h)!==c&&(t.update(h),i.set(h,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",a)===!1&&l.addEventListener("dispose",a),i.get(l)!==c&&(e.update(l.instanceMatrix,s.ARRAY_BUFFER),l.instanceColor!==null&&e.update(l.instanceColor,s.ARRAY_BUFFER),i.set(l,c))),l.isSkinnedMesh){const d=l.skeleton;i.get(d)!==c&&(d.update(),i.set(d,c))}return h}function o(){i=new WeakMap}function a(l){const c=l.target;c.removeEventListener("dispose",a),e.remove(c.instanceMatrix),c.instanceColor!==null&&e.remove(c.instanceColor)}return{update:r,dispose:o}}class pu extends Ie{constructor(t,e,n,i,r,o,a,l,c,u=rs){if(u!==rs&&u!==ms)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");n===void 0&&u===rs&&(n=Ci),n===void 0&&u===ms&&(n=ps),super(null,i,r,o,a,l,u,n,c),this.isDepthTexture=!0,this.image={width:t,height:e},this.magFilter=a!==void 0?a:De,this.minFilter=l!==void 0?l:De,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(t){return super.copy(t),this.compareFunction=t.compareFunction,this}toJSON(t){const e=super.toJSON(t);return this.compareFunction!==null&&(e.compareFunction=this.compareFunction),e}}const mu=new Ie,Bc=new pu(1,1),gu=new ou,_u=new cf,vu=new du,kc=[],Vc=[],Hc=new Float32Array(16),Gc=new Float32Array(9),Wc=new Float32Array(4);function Es(s,t,e){const n=s[0];if(n<=0||n>0)return s;const i=t*e;let r=kc[i];if(r===void 0&&(r=new Float32Array(i),kc[i]=r),t!==0){n.toArray(r,0);for(let o=1,a=0;o!==t;++o)a+=e,s[o].toArray(r,a)}return r}function Ue(s,t){if(s.length!==t.length)return!1;for(let e=0,n=s.length;e<n;e++)if(s[e]!==t[e])return!1;return!0}function Ne(s,t){for(let e=0,n=t.length;e<n;e++)s[e]=t[e]}function Eo(s,t){let e=Vc[t];e===void 0&&(e=new Int32Array(t),Vc[t]=e);for(let n=0;n!==t;++n)e[n]=s.allocateTextureUnit();return e}function E0(s,t){const e=this.cache;e[0]!==t&&(s.uniform1f(this.addr,t),e[0]=t)}function A0(s,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(s.uniform2f(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(Ue(e,t))return;s.uniform2fv(this.addr,t),Ne(e,t)}}function R0(s,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(s.uniform3f(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else if(t.r!==void 0)(e[0]!==t.r||e[1]!==t.g||e[2]!==t.b)&&(s.uniform3f(this.addr,t.r,t.g,t.b),e[0]=t.r,e[1]=t.g,e[2]=t.b);else{if(Ue(e,t))return;s.uniform3fv(this.addr,t),Ne(e,t)}}function C0(s,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(s.uniform4f(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(Ue(e,t))return;s.uniform4fv(this.addr,t),Ne(e,t)}}function P0(s,t){const e=this.cache,n=t.elements;if(n===void 0){if(Ue(e,t))return;s.uniformMatrix2fv(this.addr,!1,t),Ne(e,t)}else{if(Ue(e,n))return;Wc.set(n),s.uniformMatrix2fv(this.addr,!1,Wc),Ne(e,n)}}function D0(s,t){const e=this.cache,n=t.elements;if(n===void 0){if(Ue(e,t))return;s.uniformMatrix3fv(this.addr,!1,t),Ne(e,t)}else{if(Ue(e,n))return;Gc.set(n),s.uniformMatrix3fv(this.addr,!1,Gc),Ne(e,n)}}function L0(s,t){const e=this.cache,n=t.elements;if(n===void 0){if(Ue(e,t))return;s.uniformMatrix4fv(this.addr,!1,t),Ne(e,t)}else{if(Ue(e,n))return;Hc.set(n),s.uniformMatrix4fv(this.addr,!1,Hc),Ne(e,n)}}function I0(s,t){const e=this.cache;e[0]!==t&&(s.uniform1i(this.addr,t),e[0]=t)}function U0(s,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(s.uniform2i(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(Ue(e,t))return;s.uniform2iv(this.addr,t),Ne(e,t)}}function N0(s,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(s.uniform3i(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(Ue(e,t))return;s.uniform3iv(this.addr,t),Ne(e,t)}}function F0(s,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(s.uniform4i(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(Ue(e,t))return;s.uniform4iv(this.addr,t),Ne(e,t)}}function O0(s,t){const e=this.cache;e[0]!==t&&(s.uniform1ui(this.addr,t),e[0]=t)}function z0(s,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(s.uniform2ui(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(Ue(e,t))return;s.uniform2uiv(this.addr,t),Ne(e,t)}}function B0(s,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(s.uniform3ui(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(Ue(e,t))return;s.uniform3uiv(this.addr,t),Ne(e,t)}}function k0(s,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(s.uniform4ui(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(Ue(e,t))return;s.uniform4uiv(this.addr,t),Ne(e,t)}}function V0(s,t,e){const n=this.cache,i=e.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i);let r;this.type===s.SAMPLER_2D_SHADOW?(Bc.compareFunction=iu,r=Bc):r=mu,e.setTexture2D(t||r,i)}function H0(s,t,e){const n=this.cache,i=e.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i),e.setTexture3D(t||_u,i)}function G0(s,t,e){const n=this.cache,i=e.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i),e.setTextureCube(t||vu,i)}function W0(s,t,e){const n=this.cache,i=e.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i),e.setTexture2DArray(t||gu,i)}function X0(s){switch(s){case 5126:return E0;case 35664:return A0;case 35665:return R0;case 35666:return C0;case 35674:return P0;case 35675:return D0;case 35676:return L0;case 5124:case 35670:return I0;case 35667:case 35671:return U0;case 35668:case 35672:return N0;case 35669:case 35673:return F0;case 5125:return O0;case 36294:return z0;case 36295:return B0;case 36296:return k0;case 35678:case 36198:case 36298:case 36306:case 35682:return V0;case 35679:case 36299:case 36307:return H0;case 35680:case 36300:case 36308:case 36293:return G0;case 36289:case 36303:case 36311:case 36292:return W0}}function q0(s,t){s.uniform1fv(this.addr,t)}function Y0(s,t){const e=Es(t,this.size,2);s.uniform2fv(this.addr,e)}function j0(s,t){const e=Es(t,this.size,3);s.uniform3fv(this.addr,e)}function K0(s,t){const e=Es(t,this.size,4);s.uniform4fv(this.addr,e)}function Z0(s,t){const e=Es(t,this.size,4);s.uniformMatrix2fv(this.addr,!1,e)}function $0(s,t){const e=Es(t,this.size,9);s.uniformMatrix3fv(this.addr,!1,e)}function J0(s,t){const e=Es(t,this.size,16);s.uniformMatrix4fv(this.addr,!1,e)}function Q0(s,t){s.uniform1iv(this.addr,t)}function tg(s,t){s.uniform2iv(this.addr,t)}function eg(s,t){s.uniform3iv(this.addr,t)}function ng(s,t){s.uniform4iv(this.addr,t)}function ig(s,t){s.uniform1uiv(this.addr,t)}function sg(s,t){s.uniform2uiv(this.addr,t)}function rg(s,t){s.uniform3uiv(this.addr,t)}function og(s,t){s.uniform4uiv(this.addr,t)}function ag(s,t,e){const n=this.cache,i=t.length,r=Eo(e,i);Ue(n,r)||(s.uniform1iv(this.addr,r),Ne(n,r));for(let o=0;o!==i;++o)e.setTexture2D(t[o]||mu,r[o])}function lg(s,t,e){const n=this.cache,i=t.length,r=Eo(e,i);Ue(n,r)||(s.uniform1iv(this.addr,r),Ne(n,r));for(let o=0;o!==i;++o)e.setTexture3D(t[o]||_u,r[o])}function cg(s,t,e){const n=this.cache,i=t.length,r=Eo(e,i);Ue(n,r)||(s.uniform1iv(this.addr,r),Ne(n,r));for(let o=0;o!==i;++o)e.setTextureCube(t[o]||vu,r[o])}function hg(s,t,e){const n=this.cache,i=t.length,r=Eo(e,i);Ue(n,r)||(s.uniform1iv(this.addr,r),Ne(n,r));for(let o=0;o!==i;++o)e.setTexture2DArray(t[o]||gu,r[o])}function ug(s){switch(s){case 5126:return q0;case 35664:return Y0;case 35665:return j0;case 35666:return K0;case 35674:return Z0;case 35675:return $0;case 35676:return J0;case 5124:case 35670:return Q0;case 35667:case 35671:return tg;case 35668:case 35672:return eg;case 35669:case 35673:return ng;case 5125:return ig;case 36294:return sg;case 36295:return rg;case 36296:return og;case 35678:case 36198:case 36298:case 36306:case 35682:return ag;case 35679:case 36299:case 36307:return lg;case 35680:case 36300:case 36308:case 36293:return cg;case 36289:case 36303:case 36311:case 36292:return hg}}class dg{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.setValue=X0(e.type)}}class fg{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.size=e.size,this.setValue=ug(e.type)}}class pg{constructor(t){this.id=t,this.seq=[],this.map={}}setValue(t,e,n){const i=this.seq;for(let r=0,o=i.length;r!==o;++r){const a=i[r];a.setValue(t,e[a.id],n)}}}const na=/(\w+)(\])?(\[|\.)?/g;function Xc(s,t){s.seq.push(t),s.map[t.id]=t}function mg(s,t,e){const n=s.name,i=n.length;for(na.lastIndex=0;;){const r=na.exec(n),o=na.lastIndex;let a=r[1];const l=r[2]==="]",c=r[3];if(l&&(a=a|0),c===void 0||c==="["&&o+2===i){Xc(e,c===void 0?new dg(a,s,t):new fg(a,s,t));break}else{let h=e.map[a];h===void 0&&(h=new pg(a),Xc(e,h)),e=h}}}class uo{constructor(t,e){this.seq=[],this.map={};const n=t.getProgramParameter(e,t.ACTIVE_UNIFORMS);for(let i=0;i<n;++i){const r=t.getActiveUniform(e,i),o=t.getUniformLocation(e,r.name);mg(r,o,this)}}setValue(t,e,n,i){const r=this.map[e];r!==void 0&&r.setValue(t,n,i)}setOptional(t,e,n){const i=e[n];i!==void 0&&this.setValue(t,n,i)}static upload(t,e,n,i){for(let r=0,o=e.length;r!==o;++r){const a=e[r],l=n[a.id];l.needsUpdate!==!1&&a.setValue(t,l.value,i)}}static seqWithValue(t,e){const n=[];for(let i=0,r=t.length;i!==r;++i){const o=t[i];o.id in e&&n.push(o)}return n}}function qc(s,t,e){const n=s.createShader(t);return s.shaderSource(n,e),s.compileShader(n),n}const gg=37297;let _g=0;function vg(s,t){const e=s.split(`
`),n=[],i=Math.max(t-6,0),r=Math.min(t+6,e.length);for(let o=i;o<r;o++){const a=o+1;n.push(`${a===t?">":" "} ${a}: ${e[o]}`)}return n.join(`
`)}const Yc=new Ht;function xg(s){Kt._getMatrix(Yc,Kt.workingColorSpace,s);const t=`mat3( ${Yc.elements.map(e=>e.toFixed(4))} )`;switch(Kt.getTransfer(s)){case To:return[t,"LinearTransferOETF"];case ce:return[t,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space: ",s),[t,"LinearTransferOETF"]}}function jc(s,t,e){const n=s.getShaderParameter(t,s.COMPILE_STATUS),i=s.getShaderInfoLog(t).trim();if(n&&i==="")return"";const r=/ERROR: 0:(\d+)/.exec(i);if(r){const o=parseInt(r[1]);return e.toUpperCase()+`

`+i+`

`+vg(s.getShaderSource(t),o)}else return i}function yg(s,t){const e=xg(t);return[`vec4 ${s}( vec4 value ) {`,`	return ${e[1]}( vec4( value.rgb * ${e[0]}, value.a ) );`,"}"].join(`
`)}function Mg(s,t){let e;switch(t){case xd:e="Linear";break;case yd:e="Reinhard";break;case Md:e="Cineon";break;case Wh:e="ACESFilmic";break;case bd:e="AgX";break;case wd:e="Neutral";break;case Sd:e="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",t),e="Linear"}return"vec3 "+s+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}const Hr=new P;function Sg(){Kt.getLuminanceCoefficients(Hr);const s=Hr.x.toFixed(4),t=Hr.y.toFixed(4),e=Hr.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${s}, ${t}, ${e} );`,"	return dot( weights, rgb );","}"].join(`
...
`)}function Tg(s,t){const e={},n=s.getProgramParameter(t,s.ACTIVE_ATTRIBUTES);for(let i=0;i<n;i++){const r=s.getActiveAttrib(t,i),o=r.name;let a=1;r.type===s.FLOAT_MAT2&&(a=2),r.type===s.FLOAT_MAT3&&(a=3),r.type===s.FLOAT_MAT4&&(a=4),e[o]={type:r.type,location:s.getAttribLocation(t,o),locationSize:a}}return e}function Ys(s){return s!==""}function Kc(s,t){const e=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return s.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,e).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function Zc(s,t){return s.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}const Eg=/^[ \t]*#include +<([\w\d./]+)>/gm;function ll(s){return s.replace(Eg,Rg)}const Ag=new Map;function Rg(s,t){let e=Wt[t];if(e===void 0){const n=Ag.get(t);if(n!==void 0)e=Wt[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',t,n);else throw new Error("Can not resolve #include <"+t+">")}return ll(e)}const Cg=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function $c(s){return s.replace(Cg,Pg)}function Pg(s,t,e,n){let i="";for(let r=parseInt(t);r<parseInt(e);r++)i+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return i}function Jc(s){let t=`precision ${s.precision} float;
...
#define LOW_PRECISION`),t}function Dg(s){let t="SHADOWMAP_TYPE_BASIC";return s.shadowMapType===Hh?t="SHADOWMAP_TYPE_PCF":s.shadowMapType===Gh?t="SHADOWMAP_TYPE_PCF_SOFT":s.shadowMapType===zn&&(t="SHADOWMAP_TYPE_VSM"),t}function Lg(s){let t="ENVMAP_TYPE_CUBE";if(s.envMap)switch(s.envMapMode){case ds:case fs:t="ENVMAP_TYPE_CUBE";break;case bo:t="ENVMAP_TYPE_CUBE_UV";break}return t}function Ig(s){let t="ENVMAP_MODE_REFLECTION";if(s.envMap)switch(s.envMapMode){case fs:t="ENVMAP_MODE_REFRACTION";break}return t}function Ug(s){let t="ENVMAP_BLENDING_NONE";if(s.envMap)switch(s.combine){case So:t="ENVMAP_BLENDING_MULTIPLY";break;case _d:t="ENVMAP_BLENDING_MIX";break;case vd:t="ENVMAP_BLENDING_ADD";break}return t}function Ng(s){const t=s.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),112)),texelHeight:n,maxMip:e}}function Fg(s,t,e,n){const i=s.getContext(),r=e.defines;let o=e.vertexShader,a=e.fragmentShader;const l=Dg(e),c=Lg(e),u=Ig(e),h=Ug(e),d=Ng(e),f=bg(e),g=wg(r),_=i.createProgram();let m,p,b=e.glslVersion?"#version "+e.glslVersion+`
...
`)+`
`+p);const x=b+m+o,v=b+p+a,C=qc(i,i.VERTEX_SHADER,x),T=qc(i,i.FRAGMENT_SHADER,v);i.attachShader(_,C),i.attachShader(_,T),e.index0AttributeName!==void 0?i.bindAttribLocation(_,0,e.index0AttributeName):e.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function E(D){if(s.debug.checkShaderErrors){const O=i.getProgramInfoLog(_).trim(),F=i.getShaderInfoLog(C).trim(),z=i.getShaderInfoLog(T).trim();let G=!0,B=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(G=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(i,_,C,T);else{const K=jc(i,C,"vertex"),W=jc(i,T,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
...
`;continue}if((B=G.match(y))&&(z.gamma=parseFloat(B[1])),(B=G.match(D))&&(z.exposure=parseFloat(B[1])),(B=G.match(O))&&(z.valid|=2,z.format=B[1]),(B=G.match(F))&&(z.valid|=4,z.height=parseInt(B[1],10),z.width=parseInt(B[2],10)),z.valid&2&&z.valid&4)break}return z.valid&2||o(3,"missing format specifier"),z.valid&4||o(3,"missing image size specifier"),z},f=function(A,M,y){const D=M;if(D<8||D>32767||A[0]!==2||A[1]!==2||A[2]&128)return new Uint8Array(A);D!==(A[2]<<8|A[3])&&o(3,"wrong scanline width");const O=new Uint8Array(4*M*y);O.length||o(4,"unable to allocate buffer space");let F=0,z=0;const G=4*D,B=new Uint8Array(4),K=new Uint8Array(G);let W=y;for(;W>0&&z<A.byteLength;){z+4>A.byteLength&&o(1),B[0]=A[z++],B[1]=A[z++],B[2]=A[z++],B[3]=A[z++],(B[0]!=2||B[1]!=2||(B[2]<<8|B[3])!=D)&&o(3,"bad rgbe scanline format");let nt=0,st;for(;nt<G&&z<A.byteLength;){st=A[z++];const Ct=st>128;if(Ct&&(st-=128),(st===0||nt+st>G)&&o(3,"bad scanline data"),Ct){const Ut=A[z++];for(let q=0;q<st;q++)K[nt++]=Ut}else K.set(A.subarray(z,z+st),nt),nt+=st,z+=st}const pt=D;for(let Ct=0;Ct<pt;Ct++){let Ut=0;O[F]=K[Ct+Ut],Ut+=D,O[F+1]=K[Ct+Ut],Ut+=D,O[F+2]=K[Ct+Ut],Ut+=D,O[F+3]=K[Ct+Ut],F+=4}W--}return O},g=function(A,M,y,D){const O=A[M+3],F=Math.pow(2,O-128)/255;y[D+0]=A[M+0]*F,y[D+1]=A[M+1]*F,y[D+2]=A[M+2]*F,y[D+3]=1},_=function(A,M,y,D){const O=A[M+3],F=Math.pow(2,O-128)/255;y[D+0]=Pr.toHalfFloat(Math.min(A[M+0]*F,65504)),y[D+1]=Pr.toHalfFloat(Math.min(A[M+1]*F,65504)),y[D+2]=Pr.toHalfFloat(Math.min(A[M+2]*F,65504)),y[D+3]=Pr.toHalfFloat(1)},m=new Uint8Array(t);m.pos=0;const p=d(m),b=p.width,x=p.height,v=f(m.subarray(m.pos),b,x);let C,T,E;switch(this.type){case Le:E=v.length/4;const A=new Float32Array(E*4);for(let y=0;y<E;y++)g(v,y*4,A,y*4);C=A,T=Le;break;case nn:E=v.length/4;const M=new Uint16Array(E*4);for(let y=0;y<E;y++)_(v,y*4,M,y*4);C=M,T=nn;break;default:throw new Error("THREE.RGBELoader: Unsupported type: "+this.type)}return{width:b,height:x,data:C,header:p.string,gamma:p.gamma,exposure:p.exposure,type:T}}setDataType(t){return this.type=t,this}load(t,e,n,i){function r(o,a){switch(o.type){case Le:case nn:o.colorSpace=Xe,o.minFilter=Me,o.magFilter=Me,o.generateMipmaps=!1,o.flipY=!0;break}e&&e(o,a)}return super.load(t,r,n,i)}}const Xx={};class qx{constructor(){this.name="Bloom",this.category="flora",this._clock=new Fi,this._loaded=!1,this._renderer=null,this._scene=null,this._camera=null,this._group=null,this._petalMesh=null,this._stemMesh=null,this._particles=null,this._startProgress=0,this._groupRotY=0,this._animStartTime=-1,this._pointer=new Z(0,0),this._distortRT1=null,this._distortRT2=null,this._distortPhase=!1,this._distortScene=null,this._distortCamera=null,this._distortMat=null,this._lastNDC=new Z(.5,.5),this._currNDC=new Z(.5,.5),this._pointerDiff=0,this._isPointerEnter=!1,this._compScene=null,this._compCamera=null,this._compMat=null,this._mainRT=null,this._uStartProgress={value:0},this._uTime={value:0}}getCamera(){return this._camera}getLights(){return[]}getBackground(){return null}async init(t,e){this._renderer=e,this._scene=new ls;const n=document.createElement("canvas");n.width=2,n.height=512;const i=n.getContext("2d"),r=i.createLinearGradient(0,0,0,512);r.addColorStop(0,"#000000"),r.addColorStop(1,"#8386ff"),i.fillStyle=r,i.fillRect(0,0,2,512);const o=new S_(n);this._scene.background=o,this._camera=new ye(50,window.innerWidth/window.innerHeight,.1,100),this._camera.position.set(0,2,0),this._camera.zoom=2.5,this._camera.updateProjectionMatrix(),this._camera.lookAt(0,0,0),this._group=new je,this._group.rotation.y=0,this._scene.add(this._group),await this._loadAssets(e),this._setupDistortion(e),this._setupComposite(e),this._bindPointer(e),this._animStartTime=this._clock.getElapsedTime(),this._loaded=!0}async _loadAssets(t){const e=new Uu,n=new Wx,i=typeof Xx<"u"&&"/3DProcedural_Ecosystem/"||"/",[r,o,a]=await Promise.all([new Promise((h,d)=>e.load(i+"model/bloom-petal.glb",h,void 0,d)),new Promise((h,d)=>e.load(i+"model/bloom-stem.glb",h,void 0,d)),new Promise((h,d)=>n.load(i+"model/dawn.hdr",h,void 0,d))]),l=new al(t);l.compileEquirectangularShader();const c=l.fromEquirectangular(a);this._scene.environment=c.texture,this._scene.environmentIntensity=.5,this._scene.environmentRotation=new sn(0,-Math.PI/1.5,0),a.dispose(),l.dispose();const u=o.scene;u.position.set(0,-3.3,-.03),u.scale.setScalar(.8),u.traverse(h=>{h.isMesh&&(h.material=new ys({roughness:.5,color:"#ffffff"}))}),this._group.add(u),this._stemMesh=u,this._setupPetals(r),this._setupParticles()}_setupPetals(t){let e=null,n=null;if(t.scene.traverse(c=>{c.isMesh&&!e&&(e=c.geometry,n=c.material)}),!e)return;const i=new ys({side:Pe,map:n.map,normalMap:n.normalMap,roughnessMap:n.roughnessMap,metalnessMap:n.metalnessMap,emissiveMap:n.emissiveMap});i.map&&(i.map.colorSpace=Ee);const r=this._uStartProgress,o=this._uTime;i.onBeforeCompile=c=>{c.uniforms.uStartProgress=r,c.uniforms.uTime=o,c.vertexShader=c.vertexShader.replace("#include <common>",`
        #include <common>
        ...
        `)};const a=new mr(e,i,128),l=new re;for(let c=0;c<128;c++)l.rotation.set(0,dr.degToRad(140*c),0),l.updateMatrix(),a.setMatrixAt(c,l.matrix);a.instanceMatrix.needsUpdate=!0,this._group.add(a),this._petalMesh=a}_setupParticles(){const n=new Float32Array(1200),i=new Float32Array(400*3),r=new Float32Array(400);for(let l=0;l<400;l++)n[l*3]=(Math.random()-.5)*20,n[l*3+1]=(Math.random()-.5)*20,n[l*3+2]=(Math.random()-.5)*20,r[l]=Math.random();const o=new ue;o.setAttribute("position",new pe(n,3)),o.setAttribute("aPhase",new pe(r,1)),this._particleVel=i;const a=new ge({uniforms:{uTime:{value:0}},vertexShader:`
      ...
      `});const r=new ne(new fn(2,2),this._distortMat);this._distortScene.add(r)}_setupComposite(t){const e=window.innerWidth,n=window.innerHeight;this._mainRT=new ke(e,n,{minFilter:Me,magFilter:Me}),this._compScene=new ls,this._compCamera=new vs(-1,1,1,-1,0,1),this._compMat=new ge({uniforms:{tScene:{value:null},tDistort:{value:null}},vertexShader:`
        varying vec2 vUv;
        void main() { vUv = uv; gl_Position = vec4(position, 1.0); }
      `,fragmentShader:`
      ...
      `});const i=new ne(new fn(2,2),this._compMat);this._compScene.add(i)}_bindPointer(t){const e=t.domElement;this._onMove=n=>{const i=e.getBoundingClientRect();this._pointer.set((n.clientX-i.left)/i.width*2-1,-((n.clientY-i.top)/i.height)*2+1);const r=(n.clientX-i.left)/i.width,o=(n.clientY-i.top)/i.height;this._lastNDC.copy(this._currNDC),this._currNDC.set(r,o);const a=this._currNDC.x-this._lastNDC.x,l=this._currNDC.y-this._lastNDC.y;this._pointerDiff=Math.sqrt(a*a+l*l)},this._onEnter=()=>{this._isPointerEnter=!0},this._onLeave=()=>{this._isPointerEnter=!1},e.addEventListener("pointermove",this._onMove),e.addEventListener("pointerenter",this._onEnter),e.addEventListener("pointerleave",this._onLeave)}update(t,e){if(!this._loaded)return;const n=this._clock.getElapsedTime(),i=n-this._animStartTime,r=Math.min(i/2,1),o=r*r*(3-2*r)*2;this._camera.position.z=o;const a=Math.min(i/1.5,1);this._group.rotation.y=-(a*a*(3-2*a))*Math.PI/2;const l=Math.max(i-.5,0),c=Math.min(l/5.5,1);this._startProgress=c*c*(3-2*c),this._uStartProgress.value=this._startProgress,this._uTime.value=n;const u=-(.3*this._pointer.x);if(this._camera.position.x+=(u-this._camera.position.x)*.05,this._camera.position.y+=(2-this._camera.position.y)*.05,r>=1&&(this._camera.position.z+=(2-this._camera.position.z)*.05),this._camera.lookAt(0,0,0),this._particles){this._particles.material.uniforms.uTime.value=n;const h=this._particles.geometry.getAttribute("position"),d=h.array,f=this._particleVel;for(let g=0;g<h.count;g++){const _=g*3;f[_+1]-=.0098,d[_]+=f[_],d[_+1]+=f[_+1],d[_+2]+=f[_+2],d[_+1]<0&&(d[_+1]=0,f[_+1]=-f[_+1])}h.needsUpdate=!0}}render(t){if(!this._loaded)return;t.setRenderTarget(this._mainRT),t.render(this._scene,this._camera);const e=this._distortPhase?this._distortRT2:this._distortRT1,n=this._distortPhase?this._distortRT1:this._distortRT2;this._distortMat.uniforms.tPrev.value=e.texture,this._distortMat.uniforms.uPointer.value.copy(this._currNDC),this._distortMat.uniforms.uLastPointer.value.copy(this._lastNDC),this._distortMat.uniforms.uDiff.value=this._pointerDiff,this._distortMat.uniforms.uIsPointerEnter.value=this._isPointerEnter?1:0,t.setRenderTarget(n),t.render(this._distortScene,this._distortCamera),this._distortPhase=!this._distortPhase,this._pointerDiff*=.95,this._compMat.uniforms.tScene.value=this._mainRT.texture,this._compMat.uniforms.tDistort.value=n.texture,t.setRenderTarget(null),t.render(this._compScene,this._compCamera)}onResize(t,e){this._camera&&(this._camera.aspect=t/e,this._camera.updateProjectionMatrix()),this._mainRT&&this._mainRT.setSize(t,e),this._distortRT1&&(this._distortRT1.setSize(t,e),this._distortRT2.setSize(t,e)),this._distortMat&&(this._distortMat.uniforms.uAspect.value=t/e)}dispose(){var e;this._mainRT&&this._mainRT.dispose(),this._distortRT1&&(this._distortRT1.dispose(),this._distortRT2.dispose());const t=(e=this._renderer)==null?void 0:e.domElement;t&&(t.removeEventListener("pointermove",this._onMove),t.removeEventListener("pointerenter",this._onEnter),t.removeEventListener("pointerleave",this._onLeave))}}class Yx{static wingFlapFunction(t={}){const{timeUniform:e="uTime",frequencyUniform:n="uFlapFrequency",amplitudeUniform:i="uFlapAmplitude"}=t;return`
      /**
       * 计算翅膀扇动的顶点偏移
       * @param pos - 顶点原始位置
    ...
    `}}class Ou extends Ps{constructor(t={}){super({power:8,iterations:12,bailout:2,scale:2,colorA:[.1,.2,.6],colorB:[.9,.3,.1],glowIntensity:.5,animate:!0,...t})}_buildGeometry(){return new fn(2,2)}_buildMaterial(){const t=this._params,e=`
      precision highp float;
      out vec2 vUv;
      void main() {
        vUv = uv;
    ...
    `;return new qn({vertexShader:e,fragmentShader:n,transparent:!1,side:yn,depthWrite:!1,depthTest:!1,uniforms:{uPower:{value:t.power},uIterations:{value:t.iterations},uBailout:{value:t.bailout},uScale:{value:t.scale},uColorA:{value:new P(...t.colorA)},uColorB:{value:new P(...t.colorB)},uGlowIntensity:{value:t.glowIntensity},uAnimate:{value:t.animate?1:0}}})}_buildMesh(){const t=new ne(this._geometry,this._material);return t.frustumCulled=!1,t}setPower(t){return this._material&&(this._material.uniforms.uPower.value=t),this}}Ts.register("MandelbulbFractal",Ou,{power:8,colorA:[.1,.2,.6],colorB:[.9,.3,.1]});class Zx{static glsl(){return`
    ...
    `}}class zu extends Ps{constructor(t={}){super({colorTop:[.1,.8,.3],colorBottom:[.3,.1,.6],colorAccent:[.1,.3,.9],height:5,curtainWidth:15,speed:.3,intensity:1.5,turbulence:1,raySteps:48,...t})}_buildGeometry(){return new fn(2,2)}_buildMaterial(){const t=this._params,e=`
      precision highp float;
      out vec2 vUv;
      void main() {
        vUv = uv;
...
`;class ty extends Ds{getDefaults(){return{highlightColor:16761600,midtoneColor:16719616,lowlightColor:2949375,baseColor:16772075,blurFactor:.6,speed:1,zoom:1}}static get fragmentShader(){return sy}}class ey extends Ds{getDefaults(){return{color1:35980,color2:15918901,backgroundColor:14155663,amplitudeFactor:1,ringFactor:1,rotationFactor:1,size:1.5,speed:1}}static get fragmentShader(){return ry}}class ny extends Ds{getDefaults(){return{backgroundColor:16777215,skyColor:6863063,cloudColor:11387358,cloudShadowColor:1586512,sunColor:16750873,sunGlareColor:16737843,sunlightColor:16750899,speed:1}}static get fragmentShader(){return oy}}class iy extends Ds{getDefaults(){return{color1:396069,color2:16777215,backgroundColor:16185078,amplitudeFactor:1,ringFactor:4,rotationFactor:.1,speed:1}}static get fragmentShader(){return ay}}const sy=`
uniform vec2 iResolution;
uniform vec2 iMouse;
uniform float iTime;
...
void main(){
  ...
  gl_FragColor=vec4(out1,1.);
        ...
        `;const st=nt.querySelector(".tc-slider"),pt=nt.querySelector(".tc-value"),Ct=B;st.addEventListener("input",()=>{const Ut=parseFloat(st.value);pt.textContent=_(Ut,Ct),b(O,Ut,!1)}),st.addEventListener("change",()=>{const Ut=parseFloat(st.value);b(O,Ut,!0)})}(y||M).appendChild(nt)}if(!T.isCanvas){const D=document.createElement("div");D.className="tc-group",D.innerHTML='<div class="tc-group-title">📷 相机</div>';const O=p("FOV",10,150,1,Oe.fov,z=>{Oe.fov=z,Oe.updateProjectionMatrix()});D.appendChild(O);const F=p("Z 距离",-500,500,1,Oe.position.z,z=>{Oe.position.z=z});D.appendChild(F),M.appendChild(D)}E.appendChild(M),r.appendChild(E)}function p(C,T,E,A,M,y){const D=document.createElement("div");D.className="tc-row",D.innerHTML=`
      <span class="tc-label">${C}</span>
      <input type="range" class="tc-slider" min="${T}" max="${E}" step="${A}" value="${M}">
      <span class="tc-value">${_(M,A)}</span>
    `;const O=D.querySelector(".tc-slider"),F=D.querySelector(".tc-value");return O.addEventListener("input",()=>{const z=parseFloat(O.value);F.textContent=_(z,A),y(z)}),D}function b(C,T,E){const A=tt,M=$e[Qt];if(!(!A||!M)){if(te[C]=T,M.isVanta&&A._uniforms){const y=A._uniforms;if(y[C])if(/color|background|tint|hue/i.test(C)&&typeof T=="number"){const D=new ut(T);y[C].value.set(D.r,D.g,D.b)}else y[C].value=T;A._params&&(A._params[C]=T);return}if(M.is3DVanta&&A.options){A.options[C]=T;return}if(M.isCanvas&&A._params){A._params[C]=T;return}A._params&&(A._params[C]=T),A.options&&(A.options[C]=T),A._mesh&&x(A._mesh,C,T),A._group&&A._group.traverse(y=>{y.isMesh&&y.material&&y.material.uniforms&&x(y,C,T)}),E&&(Li(Qt,te),setTimeout(()=>m(Qt),50))}}function x(C,T,E){if(!C.material)return;const A=Array.isArray(C.material)?C.material:[C.material];for(const M of A){if(!M.uniforms)continue;if(M.uniforms[T])if(/color/i.test(T)&&typeof E=="number"){const D=new ut(E);M.uniforms[T].value&&M.uniforms[T].value.isVector3?M.uniforms[T].value.set(D.r,D.g,D.b):M.uniforms[T].value=D}else typeof E=="number"&&(M.uniforms[T].value=E);const y="u"+T.charAt(0).toUpperCase()+T.slice(1);M.uniforms[y]&&typeof E=="number"&&(M.uniforms[y].value=E)}}o.addEventListener("click",()=>{const C={mode:Qt,params:{...te}};navigator.clipboard.writeText(JSON.stringify(C,null,2)).then(()=>{g("✅ 参数已复制到剪贴板")})}),c.addEventListener("click",()=>{const C={mode:Qt,params:{...te}};navigator.clipboard.writeText(JSON.stringify(C,null,2)).then(()=>{g("📋 JSON 已复制")})}),a.addEventListener("click",()=>{!f||!$e[f]||(te={...$e[f].defs},Li(Qt,te),Kl(Qt),setTimeout(()=>m(Qt),50),g("↩ 已重置为默认值"))}),l.addEventListener("click",()=>{const C={mode:Qt,params:{...te}};localStorage.setItem("tc-3d-saved-"+Qt,JSON.stringify(C)),g("💾 已保存到本地")});const v=window.appSwitch;window.appSwitch=function(C){v(C);const T=localStorage.getItem("tc-3d-saved-"+C);if(T)try{const{params:E}=JSON.parse(T)}catch{}setTimeout(()=>m(C),80)},setTimeout(()=>m(Qt),200)})();
