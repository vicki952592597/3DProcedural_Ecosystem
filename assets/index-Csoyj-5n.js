...
`;class Fx{static wingFlapFunction(t={}){const{timeUniform:e="uTime",frequencyUniform:n="uFlapFrequency",amplitudeUniform:i="uFlapAmplitude"}=t;return`
      /**
       * 计算翅膀扇动的顶点偏移
       * @param pos - 顶点原始位置
...
`;class Gx extends ws{getDefaults(){return{highlightColor:16761600,midtoneColor:16719616,lowlightColor:2949375,baseColor:16772075,blurFactor:.6,speed:1,zoom:1}}static get fragmentShader(){return Yx}}class Wx extends ws{getDefaults(){return{color1:35980,color2:15918901,backgroundColor:14155663,amplitudeFactor:1,ringFactor:1,rotationFactor:1,size:1.5,speed:1}}static get fragmentShader(){return jx}}class Xx extends ws{getDefaults(){return{backgroundColor:16777215,skyColor:6863063,cloudColor:11387358,cloudShadowColor:1586512,sunColor:16750873,sunGlareColor:16737843,sunlightColor:16750899,speed:1}}static get fragmentShader(){return Kx}}class qx extends ws{getDefaults(){return{color1:396069,color2:16777215,backgroundColor:16185078,amplitudeFactor:1,ringFactor:4,rotationFactor:.1,speed:1}}static get fragmentShader(){return Zx}}const Yx=`
uniform vec2 iResolution;
uniform vec2 iMouse;
uniform float iTime;
